...
public class LSprotocolfiles {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsprotocolfiles_seq")
	@SequenceGenerator(name = "lsprotocolfiles_seq", sequenceName = "lsprotocolfiles_seq", allocationSize = 1)
