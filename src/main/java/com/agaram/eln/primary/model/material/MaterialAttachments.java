...
public class MaterialAttachments {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "materialattachments_seq")
	@SequenceGenerator(name = "materialattachments_seq", sequenceName = "materialattachments_seq", allocationSize = 1)
