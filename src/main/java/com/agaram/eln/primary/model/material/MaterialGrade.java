...
//	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Id
	@Column(name = "nmaterialgradecode")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "materialgrade_sequence")
	@SequenceGenerator(name = "materialgrade_sequence", sequenceName = "materialgrade_sequence", allocationSize = 1)
