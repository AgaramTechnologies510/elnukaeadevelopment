...
public class LSaudittrailconfiguration {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsaudittrailconfiguration_seq")
	@SequenceGenerator(name = "lsaudittrailconfiguration_seq", sequenceName = "lsaudittrailconfiguration_seq", allocationSize = 1)
