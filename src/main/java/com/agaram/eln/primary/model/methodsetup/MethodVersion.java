...
public class MethodVersion implements Serializable, Diffable<MethodVersion>{
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "methodversion_mvno_seq")
	@SequenceGenerator(name = "methodversion_mvno_seq", sequenceName = "methodversion_mvno_seq", allocationSize = 1)
