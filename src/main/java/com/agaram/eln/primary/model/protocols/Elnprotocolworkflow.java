...
public class Elnprotocolworkflow {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "elnprotocolworkflow_seq")
	@SequenceGenerator(name = "elnprotocolworkflow_seq", sequenceName = "elnprotocolworkflow_seq", allocationSize = 1)
