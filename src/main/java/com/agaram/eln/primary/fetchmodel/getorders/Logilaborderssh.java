...
public class Logilaborderssh extends LogilabOrdermastersh {
	...
	public Logilaborderssh(Long batchcode, String batchid, String orderflag, Integer approvelstatus,
			...
			Integer ordercancell,Integer viewoption,Elnmaterial elnmaterial,MaterialInventory materialinventory,Integer approved,LSOrdernotification lsordernotification, Sample sample,
			...
			Long sitesequence, Long projectsequence, Long tasksequence, Long ordertypesequence, String sequenceid,Boolean teamselected,String modifiedby,Date modifieddate,String tittle,Integer sitecode,Boolean isclone,Integer sheetversionno,LSworkflow previousapprovedworkflow,Integer workflowapprovedusercode) {
		
		super(batchcode, batchid, lsworkflow, testname, lsfile, sample, lsprojectmaster, filetype, orderflag,assignedto, createdtimestamp,completedtimestamp,keyword,
				...
				modifieddate,tittle,sitecode,approved,sheetversionno,previousapprovedworkflow,workflowapprovedusercode);
