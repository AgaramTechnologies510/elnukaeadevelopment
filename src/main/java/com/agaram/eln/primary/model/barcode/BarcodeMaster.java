...
public class BarcodeMaster {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "barcodemaster_seq")
	@SequenceGenerator(name = "barcodemaster_seq", sequenceName = "barcodemaster_seq", allocationSize = 1)
