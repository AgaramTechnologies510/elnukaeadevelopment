...
public interface InstMasterRepository extends JpaRepository<InstrumentMaster, Integer>{
	 ...
	 */
	 ...
	 InstrumentMaster findByInstmastkey(Integer instmastkey);
	 /**
...
//	Object findByStatusAndSite(int i, Sort sort);
	...
	List<InstrumentMaster> findByInstcategoryAndSiteAndStatus(InstrumentCategory categoryObj, LSSiteMaster lssitemaster,
			int i);
	...
	List<InstrumentMaster> findByInstcategoryAndStatusAndInsttypeNotIn(InstrumentCategory instcat, int i,
			List<InstrumentType> excludedTypes);
