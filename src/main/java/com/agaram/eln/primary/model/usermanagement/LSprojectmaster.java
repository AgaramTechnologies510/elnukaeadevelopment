...
public class LSprojectmaster {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsprojectmaster_seq")
	@SequenceGenerator(name = "lsprojectmaster_seq", sequenceName = "lsprojectmaster_seq", allocationSize = 1)
