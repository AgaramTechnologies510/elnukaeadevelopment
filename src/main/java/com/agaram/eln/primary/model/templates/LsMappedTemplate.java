...
public class LsMappedTemplate {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsmappedtemplate_seq")
	@SequenceGenerator(name = "lsmappedtemplate_seq", sequenceName = "lsmappedtemplate_seq", allocationSize = 1)
