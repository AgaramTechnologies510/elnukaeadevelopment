...
public class ProtocolOrdersDashboard implements Comparable<ProtocolOrdersDashboard> {
	...
	public ProtocolOrdersDashboard(Long protocolordercode, Integer Testcode, String protoclordername, String orderflag,
			...
			Lsrepositoriesdata lsrepositoriesdata, Lsrepositories lsrepositories, Elnmaterial elnmaterial,
			ElnmaterialInventory elnmaterialinventory, Integer approved, Integer rejected, Integer ordercancell,
			Integer viewoption, Integer orderstarted, LSuserMaster orderstartedby, Date orderstartedon,
			Integer lockeduser, String lockedusername, Integer versionno, Elnprotocolworkflow elnprotocolworkflow,
			...
			String sequenceid, Date modifieddate, String tittle,Integer templateversionno) {
