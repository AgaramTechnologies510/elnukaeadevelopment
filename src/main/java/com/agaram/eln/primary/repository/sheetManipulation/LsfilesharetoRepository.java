...
public interface LsfilesharetoRepository extends JpaRepository<Lsfileshareto, Integer>{
	...
	List<Lsfileshareto> findBySharetounifiedidAndSharestatusAndSitecodeOrderBySharetofilecodeDesc(
			String sharetounifiedid, int i, Integer sitecode);

	Object countBySharetounifiedidAndSharestatusAndSitecode(String sharetounifiedid, int i, Integer sitecode);

	Lsfileshareto findBySharebyunifiedidAndSharetounifiedidAndSharefilecodeAndSharerights(String sharebyunifiedid,
			String sharetounifiedid, Long sharefilecode, int sharerights);

	Lsfileshareto findBySharebyunifiedidAndSharetounifiedidAndSharefilecodeAndSharerightsAndSharestatus(
			String sharebyunifiedid, String sharetounifiedid, Long sharefilecode, int sharerights, int i);
}
