...
//		List<LSsamplefile> lssamplefile = lssamplefileRepository.findByprocessed(1);
		...
		// 		: new ArrayList<Integer>();
			...
			List<Integer> userlist = objuser.getUsernotify() == null
		        ? new ArrayList<>()
		        : objuser.getUsernotify().stream()
		              .map(LSuserMaster::getUsercode)
		              .distinct()
		              .collect(Collectors.toList());
...
//											objuser.getLstprojectforfilter(), testcode));
				...
				if (testcode == -1 && objuser.getLstprojectforfilter() == null) {
					mapOrders.put("pendingorder", LSlogilabprotocoldetailRepository
							.(
									1, objuser.getLssitemaster().getSitecode(), fromdate, todate, "N", 2,
									objuser.getUsercode(), fromdate, todate, "N",
									objuser.getLssitemaster().getSitecode(), 3, objuser.getUsercode(), fromdate, todate,
									"N", objuser.getLssitemaster().getSitecode()));

					mapOrders.put("completedorder", LSlogilabprotocoldetailRepository
							.(
									1, objuser.getLssitemaster().getSitecode(), fromdate, todate, "R", 2,
									objuser.getUsercode(), fromdate, todate, "R",
									objuser.getLssitemaster().getSitecode(), 3, objuser.getUsercode(), fromdate, todate,
									"R", objuser.getLssitemaster().getSitecode()));

					mapOrders.put("rejectedorder", LSlogilabprotocoldetailRepository
							.(
									1, objuser.getLssitemaster().getSitecode(), fromdate, todate, 1, 2,
									objuser.getUsercode(), fromdate, todate, 1, objuser.getLssitemaster().getSitecode(),
									3, objuser.getUsercode(), fromdate, todate, 1,
									objuser.getLssitemaster().getSitecode()));

					mapOrders.put("canceledorder", LSlogilabprotocoldetailRepository
							.(
									1, objuser.getLssitemaster().getSitecode(), fromdate, todate, 1, 2,
									objuser.getUsercode(), fromdate, todate, 1, objuser.getLssitemaster().getSitecode(),
									3, objuser.getUsercode(), fromdate, todate, 1,
									objuser.getLssitemaster().getSitecode()));
...
//								.(
//										"R", 0, fromdate, todate, objuser.getLssitemaster().getSitecode(), "R", 1,
//										objuser, fromdate, todate, 3, objuser.getLssitemaster().getSitecode(), "R", 2,
//										objuser, fromdate, todate, 3, objuser.getLssitemaster().getSitecode(), "R", 1,
//										objuser, fromdate, todate, objuser.getLssitemaster().getSitecode(), "R", 2,
//										objuser, fromdate, todate, objuser.getLssitemaster().getSitecode(), "R", 3,
//										objuser, fromdate, todate, false, objuser.getLssitemaster().getSitecode(), "R",
//										objuser, objuser, fromdate, todate, objuser.getLssitemaster().getSitecode(),
//										"R", objuser, fromdate, todate, objuser.getLssitemaster().getSitecode()));
						lstlimscompleted.addAndGet(LogilablimsorderdetailsRepository
								.(
										"R", 0, fromdate, todate, objuser.getLssitemaster().getSitecode(), "R", 1,
										objuser, fromdate, todate, 3, objuser.getLssitemaster().getSitecode(), "R", 2,
										objuser, fromdate, todate, 3, objuser.getLssitemaster().getSitecode(), "R", 1,
										objuser, fromdate, todate, objuser.getLssitemaster().getSitecode(), "R", 2,
										objuser, fromdate, todate, objuser.getLssitemaster().getSitecode(), "R", 3,
										objuser, fromdate, todate, false, objuser.getLssitemaster().getSitecode(), "R",
										objuser, objuser, fromdate, todate, objuser.getLssitemaster().getSitecode(),3,
										"R", objuser, fromdate, todate, objuser.getLssitemaster().getSitecode(),3));
						/* for project team selection */
						lstlimscompleted.addAndGet(LogilablimsorderdetailsRepository
								.countByOrderflagAndTeamselectedAndLsprojectmasterIsNullAndViewoptionAndBatchcodeInAndCreatedtimestampBetweenAndApprovelstatusIsNullAndOrdercancellIsNullAndAssignedtoIsNullAndSitecodeOrderByBatchcodeDesc(
										"R", true, 3, selectedteambatchCodeList, fromdate, todate,
										objuser.getLssitemaster().getSitecode()));

						lstlimscompleted.addAndGet(LogilablimsorderdetailsRepository
								.countByOrderflagAndLsprojectmasterInAndCreatedtimestampBetweenAndApprovelstatusNotAndOrdercancellIsNullAndAssignedtoIsNullAndSitecode(
										"R", lstproject, fromdate, todate, 3, objuser.getLssitemaster().getSitecode()));

						lstlimscompleted.addAndGet(LogilablimsorderdetailsRepository
								.countByOrderflagAndLsprojectmasterInAndCreatedtimestampBetweenAndApprovelstatusIsNullAndOrdercancellIsNullAndAssignedtoIsNullAndSitecode(
										"R", lstproject, fromdate, todate, objuser.getLssitemaster().getSitecode()));
						
						List<Integer> usercodelist=objuser.getUsernotify().stream().map(LSuserMaster::getUsercode).collect(Collectors.toList());
						
						lstpending.addAndGet(lslogilablimsorderdetailRepository
								.countLSlogilablimsorderdetaildashboardforpending("N", 0, fromdate, todate, objuser.getUsercode(), 1,
										2, 3, usercodelist, 3,
										selectedteambatchCodeList, objuser.getLssitemaster().getSitecode(),true,false));

						
						lstRejected.addAndGet(LogilablimsorderdetailsRepository
								.(
										1, objuser, fromdate, todate, 3, objuser.getLssitemaster().getSitecode(), 2,
										objuser, fromdate, todate, 3, objuser.getLssitemaster().getSitecode(), 3,
										objuser, fromdate, todate, 3, objuser.getLssitemaster().getSitecode(), 3,
										objuser, fromdate, todate, 3, objuser.getLssitemaster().getSitecode(), objuser,
										objuser, fromdate, todate, 3, objuser.getLssitemaster().getSitecode(), objuser,
										fromdate, todate, 3, objuser.getLssitemaster().getSitecode()));
						lstRejected.addAndGet(LogilablimsorderdetailsRepository
								.countByApprovelstatusAndLsprojectmasterInAndCreatedtimestampBetweenAndAssignedtoIsNullAndSitecode(
										3, lstproject, fromdate, todate, objuser.getLssitemaster().getSitecode()));

						lstCancelled.addAndGet(LogilablimsorderdetailsRepository
								.(
										1, lstproject, fromdate, todate, objuser.getLssitemaster().getSitecode(), 1,
										objuser, fromdate, todate, 1, objuser.getLssitemaster().getSitecode(), 2,
										objuser, fromdate, todate, 1, objuser.getLssitemaster().getSitecode(), 3,
										objuser, fromdate, todate, 1, false, objuser.getLssitemaster().getSitecode(),
										objuser, objuser, fromdate, todate, 1, objuser.getLssitemaster().getSitecode(),
										objuser, fromdate, todate, 1, objuser.getLssitemaster().getSitecode()));
						/* for project team selection */
						lstCancelled.addAndGet(LogilablimsorderdetailsRepository
								.countByLsprojectmasterIsNullAndViewoptionAndTeamselectedAndBatchcodeInAndCreatedtimestampBetweenAndOrdercancellAndLsprojectmasterIsNullAndAssignedtoIsNullAndSitecode(
										3, true, selectedteambatchCodeList, fromdate, todate, 1,
										objuser.getLssitemaster().getSitecode()));

						long countcompleted = lslogilablimsorderdetailRepository
								.getLSlogilablimsorderdetaildashboardforcount("R", 3, fromdate, todate, objuser.getUsercode(),
										 objuser.getLssitemaster().getSitecode());
						lstlimscompleted.addAndGet(countcompleted);
						lstRejected.addAndGet(lslogilablimsorderdetailRepository
								.getLSlogilablimsorderdetaildashboardforrejectcount(3, fromdate, todate, objuser.getUsercode(),
										 objuser.getLssitemaster().getSitecode()));
...
//									directorycode, 3, fromdate, todate, objuser, "R", false));
					...
					lstlimscompleted.addAndGet(LogilablimsorderdetailsRepository
							.(
									3, fromdate, todate, objuser, "R", 3, objuser.getLssitemaster().getSitecode(), 3,
									fromdate, todate, objuser, "R", false, objuser.getLssitemaster().getSitecode(),
									directorycode, 1, fromdate, todate, "R", 3, objuser.getLssitemaster().getSitecode(),
									directorycode, 1, fromdate, todate, "R", objuser.getLssitemaster().getSitecode(),
									directorycode, 2, fromdate, todate, objuser, "R", 3,
									objuser.getLssitemaster().getSitecode(), directorycode, 2, fromdate, todate,
									objuser, "R", objuser.getLssitemaster().getSitecode(), directorycode, 3, fromdate,
									todate, objuser, "R", 3, objuser.getLssitemaster().getSitecode(), directorycode, 3,
									fromdate, todate, objuser, "R", false, objuser.getLssitemaster().getSitecode()));

					lstlimscompleted.addAndGet(LogilablimsorderdetailsRepository
							.(
									3, true, selectedteambatchCodeList, fromdate, todate, objuser, "R",
									objuser.getLssitemaster().getSitecode(), directorycode, true,
									selectedteambatchCodeList, 3, fromdate, todate, objuser, "R",
									objuser.getLssitemaster().getSitecode()));

					lstpending.addAndGet(LogilablimsorderdetailsRepository
							.(
									3, fromdate, todate, objuser, "N", false, objuser.getLssitemaster().getSitecode(),
									directorycode, 1, fromdate, todate, "N", objuser.getLssitemaster().getSitecode(),
									directorycode, 2, fromdate, todate, objuser, "N",
									objuser.getLssitemaster().getSitecode(), directorycode, 3, fromdate, todate,
									objuser, "N", false, objuser.getLssitemaster().getSitecode(), 3, true,
									selectedteambatchCodeList, fromdate, todate, objuser, "N",
									objuser.getLssitemaster().getSitecode(), directorycode, true,
									selectedteambatchCodeList, 3, fromdate, todate, objuser, "N",
									objuser.getLssitemaster().getSitecode()));

					lstRejected.addAndGet(LogilablimsorderdetailsRepository
							.(
									3, fromdate, todate, objuser, 3, objuser.getLssitemaster().getSitecode(),
									directorycode, 1, fromdate, todate, 3, objuser.getLssitemaster().getSitecode(),
									directorycode, 2, fromdate, todate, objuser, 3,
									objuser.getLssitemaster().getSitecode(), directorycode, 3, fromdate, todate,
									objuser, 3, objuser.getLssitemaster().getSitecode()));

					lstCancelled.addAndGet(LogilablimsorderdetailsRepository
							.(
									3, fromdate, todate, objuser, 1, false, objuser.getLssitemaster().getSitecode(),
									directorycode, 1, fromdate, todate, 1, objuser.getLssitemaster().getSitecode(),
									directorycode, 2, fromdate, todate, objuser, 1,
									objuser.getLssitemaster().getSitecode(), directorycode, 3, fromdate, todate,
									objuser, 1, false, objuser.getLssitemaster().getSitecode()));

					lstCancelled.addAndGet(LogilablimsorderdetailsRepository
							.(
									3, true, selectedteambatchCodeList, fromdate, todate, objuser, 1,
									objuser.getLssitemaster().getSitecode(), directorycode, true,
									selectedteambatchCodeList, 3, fromdate, todate, objuser, 1,
									objuser.getLssitemaster().getSitecode()));
//					lstlimscompleted.addAndGet(LogilablimsorderdetailsRepository
...
//									1, testcode);
	...
	private Map<String, Object> getallorders(List<LSprojectmaster> lstproject, Date fromdate, Date todate,
			...
			List<LSworkflow> lstworkflow, List<Long> selectedteambatchCodeList,List<LSuserMaster> uniqueUsers) {
...
//								fromdate, todate, objuser, objuser.getLssitemaster()));
			...
			List<Integer> usercodelist=uniqueUsers.stream().map(LSuserMaster::getUsercode).collect(Collectors.toList());
			
			List<LSlogilablimsorderdetail> lstordersdem = LogilablimsorderdetailsRepository
					.getLSlogilablimsorderdetaildashboardforallorders("N", 0, fromdate, todate, objuser.getUsercode(), 1, 2, 3,
							usercodelist, objuser.getLssitemaster().getSitecode(),
							objuser.getPagesize() * objuser.getPageperorder(), objuser.getPageperorder(), 3, "R",
							selectedteambatchCodeList, objuser.getLssitemaster().getSitecode(),true,false);

//				if(lstordersdem.size()<objuser.getPageperorder()) {
//					Pageable pageableobj = PageRequest.of(0, Integer.MAX_VALUE);
//					 lstorders = lslogilablimsorderdetailRepository
...
//				}
			...
			if (!lstordersdem.isEmpty()) {
				lstorders.addAll(lstordersdem.stream().map(lsOrderDetail -> new LogilabOrdermastersh(
						...
						lsOrderDetail.getTestname(), lsOrderDetail.getLsfile(), lsOrderDetail.getSample(),
						...
						lsOrderDetail.getTittle(),lsOrderDetail.getSitecode(),lsOrderDetail.getApproved(),lsOrderDetail.getSheetversionno(),lsOrderDetail.getPreviousapprovedworkflow(),lsOrderDetail.getWorkflowapprovedusercode()))
						.collect(Collectors.toList()));
			}
//			} else {
//				List<LSlogilablimsorderdetail> lstordersdem = lslogilablimsorderdetailRepository
...
//				    .collect(Collectors.toList());
	...
	public Map<String, Object> Getdashboardorders(LSuserMaster objuser) throws ParseException {
		...
		Map<String, Object> mapOrders = new HashMap<String, Object>();
		Integer testcode = objuser.getTestcode();
		Pageable pageable = PageRequest.of(objuser.getPagesize(), objuser.getPageperorder());
		...
		List<Integer> lstsampleint = lssamplemasterrepository
				.getDistinctByLssitemasterSitecodeAndStatus(objuser.getLssitemaster().getSitecode(), 1);
		Integer site = objuser.getLssitemaster().getSitecode();
		...
		List<LSuserMaster> uniqueUsers;
		if (objuser.getUsernotify() != null) {
		    uniqueUsers = objuser.getUsernotify().stream()
		        .collect(Collectors.collectingAndThen(
		            Collectors.toMap(LSuserMaster::getUsercode, u -> u, (u1, u2) -> u1),
		...
		if (lstproject != null) {
			...
			if (objuser.getObjuser().getOrderselectiontype() == 1) {
				...
				return mapOrders = getallorders(lstproject, fromdate, todate, objuser, testcode, pageable, lstsample1,
						lstworkflow, selectedteambatchCodeList,uniqueUsers);

			} else if (objuser.getObjuser().getOrderselectiontype() == 2) {
				if (testcode == -1 && objuser.getLstprojectforfilter() == null) {

//	
					Pageable pageableobj = PageRequest.of(objuser.getPagesize(), objuser.getPageperorder());

//					lstordersdem.addAll(LogilablimsorderdetailsRepository
//							.(
//									"R", 0, fromdate, todate, objuser.getLssitemaster().getSitecode(), "R", 1, objuser,
//									fromdate, todate, 3, objuser.getLssitemaster().getSitecode(), "R", 2, objuser,
//									fromdate, todate, 3, objuser.getLssitemaster().getSitecode(), "R", 1, objuser,
//									fromdate, todate, objuser.getLssitemaster().getSitecode(), "R", 2, objuser,
//									fromdate, todate, objuser.getLssitemaster().getSitecode(), "R", 3, objuser,
//									fromdate, todate, false, objuser.getLssitemaster().getSitecode(), "R", objuser,
//									objuser, fromdate, todate, objuser.getLssitemaster().getSitecode(), "R", objuser,
//									fromdate, todate, objuser.getLssitemaster().getSitecode(), pageableobj));
					
					lstordersdem.addAll(LogilablimsorderdetailsRepository
	                        .(
	                                "R", 0, fromdate, todate, objuser.getLssitemaster().getSitecode(),
	                                "R", 1, objuser, fromdate, todate, 3, objuser.getLssitemaster().getSitecode(),
	                                "R", 2, objuser, fromdate, todate, 3, objuser.getLssitemaster().getSitecode(),
	                                "R", 1, objuser, fromdate, todate, objuser.getLssitemaster().getSitecode(),
	                                "R", 2, objuser, fromdate, todate, objuser.getLssitemaster().getSitecode(),
	                                "R", 3, objuser, fromdate, todate, false, objuser.getLssitemaster().getSitecode(),
	                                "R", objuser, objuser, fromdate, todate, objuser.getLssitemaster().getSitecode(),3,
	                                "R", objuser,fromdate, todate, objuser.getLssitemaster().getSitecode(),3, pageableobj));
					/* for project team selection */
					lstordersdem.addAll(LogilablimsorderdetailsRepository
							.findByOrderflagAndTeamselectedAndLsprojectmasterIsNullAndViewoptionAndBatchcodeInAndCreatedtimestampBetweenAndApprovelstatusIsNullAndOrdercancellIsNullAndAssignedtoIsNullAndSitecodeOrderByBatchcodeDesc(
									"R", true, 3, selectedteambatchCodeList, fromdate, todate,
									objuser.getLssitemaster().getSitecode(), pageableobj));

					lstordersdem.addAll(LogilablimsorderdetailsRepository
							.findByOrderflagAndLsprojectmasterInAndCreatedtimestampBetweenAndApprovelstatusNotAndOrdercancellIsNullAndAssignedtoIsNullAndSitecode(
									"R", lstproject, fromdate, todate, 3, objuser.getLssitemaster().getSitecode(),
									pageableobj));

					lstordersdem.addAll(LogilablimsorderdetailsRepository
							.findByOrderflagAndLsprojectmasterInAndCreatedtimestampBetweenAndApprovelstatusIsNullAndOrdercancellIsNullAndAssignedtoIsNullAndSitecode(
									"R", lstproject, fromdate, todate, objuser.getLssitemaster().getSitecode(),
									pageableobj));
				...
				if (testcode == -1 && objuser.getLstprojectforfilter() == null) {
					List<Integer> usercodelist=objuser.getUsernotify().stream().map(LSuserMaster::getUsercode).collect(Collectors.toList());
					lstordersdem.addAll(lslogilablimsorderdetailRepository
							.getLSlogilablimsorderdetaildashboardforpending("N", 0, fromdate, todate, objuser.getUsercode(), 1, 2, 3,
									usercodelist, objuser.getLssitemaster().getSitecode(),
									objuser.getPagesize() * objuser.getPageperorder(), objuser.getPageperorder(), 3,
									selectedteambatchCodeList, objuser.getLssitemaster().getSitecode(),true,false));
				...
				if (testcode == -1 && objuser.getLstprojectforfilter() == null) {
					...
					lstorders.addAll(LogilablimsorderdetailsRepository
							.findByApprovelstatusAndLsprojectmasterInAndCreatedtimestampBetweenAndAssignedtoIsNullAndSitecode(
									3, lstproject, fromdate, todate, objuser.getLssitemaster().getSitecode(),pageable));
...
//									todate, 1, objuser, fromdate, todate, 1, pageable);
					...
					lstorders = LogilablimsorderdetailsRepository
							.findByLsprojectmasterIsNullAndViewoptionAndSitecodeAndTeamselectedAndBatchcodeInAndCreatedtimestampBetweenAndOrdercancellAndLsprojectmasterIsNullAndAssignedtoIsNull(
									3, site, true, selectedteambatchCodeList, fromdate, todate, 1);

					lstorders.addAll(LogilablimsorderdetailsRepository
							.(
									1, site, objuser, fromdate, todate, 1,
									1, site, lstproject, fromdate, todate,
									2, site, objuser,	fromdate, todate, 1,
									3, site, false, objuser, fromdate, todate, 1,
									objuser, site, objuser, fromdate, todate, 1,
									objuser, site, fromdate, todate, 1));
...
//									pageable);
					...
					lstorders = LogilablimsorderdetailsRepository
							.(
									3, fromdate, todate, objuser, false, objuser.getLssitemaster().getSitecode(),
									directorycode, 1, fromdate, todate, objuser.getLssitemaster().getSitecode(),
									directorycode, 2, fromdate, todate,
									objuser.getLssitemaster().getSitecode(), directorycode, 3, fromdate, todate,
									objuser, false, objuser.getLssitemaster().getSitecode(), 3, true,
									selectedteambatchCodeList, fromdate, todate, objuser,
									objuser.getLssitemaster().getSitecode(), directorycode, true,
									selectedteambatchCodeList, 3, fromdate, todate, objuser,
									objuser.getLssitemaster().getSitecode(), pageable);
...
//									selectedteambatchCodeList, 3, fromdate, todate, objuser, "R", pageable);
					...
					lstorders = LogilablimsorderdetailsRepository
							.(
									3, fromdate, todate, objuser, "R", 3, objuser.getLssitemaster().getSitecode(), 3,
									fromdate, todate, objuser, "R", false, objuser.getLssitemaster().getSitecode(),
									directorycode, 1, fromdate, todate, "R", 3, objuser.getLssitemaster().getSitecode(),
									directorycode, 1, fromdate, todate, "R", objuser.getLssitemaster().getSitecode(),
									...
									objuser, "R", objuser.getLssitemaster().getSitecode(), directorycode, 3, fromdate,
									todate, objuser, "R", 3, objuser.getLssitemaster().getSitecode(), directorycode, 3,
									fromdate, todate, objuser, "R", false,objuser.getLssitemaster().getSitecode(), 3, true,
									 selectedteambatchCodeList, fromdate,
									todate, objuser, "R", objuser.getLssitemaster().getSitecode(), directorycode, true,
									selectedteambatchCodeList, 3, fromdate, todate, objuser, "R",
									objuser.getLssitemaster().getSitecode(), pageable);
...
//									"N", pageable);
					...
					lstorders = LogilablimsorderdetailsRepository
							.(
									3, fromdate, todate, objuser, "N", false, objuser.getLssitemaster().getSitecode(),
									directorycode, 1, fromdate, todate, "N", objuser.getLssitemaster().getSitecode(),
									directorycode, 2, fromdate, todate, objuser, "N",
									objuser.getLssitemaster().getSitecode(), directorycode, false, 3, fromdate, todate,
									objuser, "N", objuser.getLssitemaster().getSitecode(), 3, true,
									selectedteambatchCodeList, fromdate, todate, objuser, "N",
									objuser.getLssitemaster().getSitecode(), directorycode, true,
									selectedteambatchCodeList, 3, fromdate, todate, objuser, "N",
									objuser.getLssitemaster().getSitecode(), pageable);
...
//									objuser, 3, pageable);
					...
					lstorders = LogilablimsorderdetailsRepository
							.(
									3, fromdate, todate, objuser, 3, objuser.getLssitemaster().getSitecode(),
									directorycode, 1, fromdate, todate, 3, objuser.getLssitemaster().getSitecode(),
									directorycode, 2, fromdate, todate, objuser, 3,
									objuser.getLssitemaster().getSitecode(), directorycode, 3, fromdate, todate,
									objuser, 3, objuser.getLssitemaster().getSitecode(), pageable);
...
//									1, pageable);
					...
					lstorders = LogilablimsorderdetailsRepository
							.(
									3, fromdate, todate, objuser, 1, false, objuser.getLssitemaster().getSitecode(), 3,
									true, selectedteambatchCodeList, fromdate, todate, objuser, 1,
									objuser.getLssitemaster().getSitecode(), directorycode, 1, fromdate, todate, 1,
									objuser.getLssitemaster().getSitecode(), directorycode, 2, fromdate, todate,
									objuser, 1, objuser.getLssitemaster().getSitecode(), directorycode, 3, fromdate,
									todate, objuser, 1, false, objuser.getLssitemaster().getSitecode(), directorycode,
									true, selectedteambatchCodeList, 3, fromdate, todate, objuser, 1,
									objuser.getLssitemaster().getSitecode(), pageable);
...
//									todate, pageable);
					...
					lstorders = LSlogilabprotocoldetailRepository
							.(
									1, objuser.getLssitemaster().getSitecode(), fromdate, todate, 2,
									objuser.getUsercode(), fromdate, todate, objuser.getLssitemaster().getSitecode(), 3,
									objuser.getUsercode(), fromdate, todate, false,
									objuser.getLssitemaster().getSitecode(), true, selectedteamprotcolorderList, 3,
									objuser.getUsercode(), fromdate, todate, objuser.getLssitemaster().getSitecode(),
									pageable);
...
//									todate, "R", pageable);
					...
					lstorders = LSlogilabprotocoldetailRepository
							.(
									1, objuser.getLssitemaster().getSitecode(), fromdate, todate, "R", 2,
									objuser.getUsercode(), fromdate, todate, "R",
									objuser.getLssitemaster().getSitecode(), 3, objuser.getUsercode(), fromdate, todate,
									"R", objuser.getLssitemaster().getSitecode(), pageable);
				} else if (testcode != -1 && objuser.getLstprojectforfilter() == null) {
					lstorders = LSlogilabprotocoldetailRepository
							.(
									1, objuser.getLssitemaster().getSitecode(), fromdate, todate, "R", testcode, 2,
...
//									todate, "N", pageable);
					...
					lstorders = LSlogilabprotocoldetailRepository
							.(
									1, objuser.getLssitemaster().getSitecode(), fromdate, todate, "N", 2,
									objuser.getUsercode(), fromdate, todate, "N",
									objuser.getLssitemaster().getSitecode(), 3, objuser.getUsercode(), fromdate, todate,
									"N", objuser.getLssitemaster().getSitecode(), pageable);
...
//									todate, 1, pageable);
					...
					lstorders = LSlogilabprotocoldetailRepository
							.(
									1, objuser.getLssitemaster().getSitecode(), fromdate, todate, 1, 2,
									objuser.getUsercode(), fromdate, todate, 1, objuser.getLssitemaster().getSitecode(),
									3, objuser.getUsercode(), fromdate, todate, 1,
									objuser.getLssitemaster().getSitecode(), pageable);
...
//									todate, 1, pageable);
					...
					lstorders = LSlogilabprotocoldetailRepository
							.(
									1, objuser.getLssitemaster().getSitecode(), fromdate, todate, 1, 2,
									objuser.getUsercode(), fromdate, todate, 1, objuser.getLssitemaster().getSitecode(),
									3, objuser.getUsercode(), fromdate, todate, 1,
									objuser.getLssitemaster().getSitecode(), pageable);
	...
	public Map<String, Object> Getdashboardsheets(LSuserMaster objuser) {
		...
		if (objuser.getUsername().equals("Administrator")) {
			lstfile = lsfileRepository
					.findByCreatedateBetweenAndFilecodeGreaterThanAndLssitemasterAndViewoptionOrCreatedateBetweenAndFilecodeGreaterThanAndCreatebyAndViewoptionOrderByFilecodeDesc(
							fromdate, todate, 1, objuser.getLssitemaster(), 1, fromdate, todate, 1, objuser, 2,
							pageable);

			count = lsfileRepository
					.countByCreatedateBetweenAndFilecodeGreaterThanAndLssitemasterAndViewoptionOrCreatedateBetweenAndFilecodeGreaterThanAndCreatebyAndViewoptionOrderByFilecodeDesc(
							fromdate, todate, 1, objuser.getLssitemaster(), 1, fromdate, todate, 1, objuser, 2);
			lstfile.forEach(
...
//								objuser.getUsercode(), 1, fromdate, todate, 1, 2, 1);
			    count = LSProtocolMasterRepository
						.countByLssitemasterAndStatusAndCreatedateBetweenAndRetirestatusAndViewoptionOrCreatedbyAndStatusAndCreatedateBetweenAndRetirestatusAndViewoptionOrderByProtocolmastercodeDesc(
								...
								objuser.getUsercode(), 1, fromdate, todate, 1, 2);
				mapSheets.put("retiredTemplate", count);
	...
	public Map<String, Object> Getordersharetome(LSuserMaster objuser) {
		...
		Date todate = objuser.getObjuser().getTodate();
		Map<String, Object> mapOrders = new HashMap<String, Object>();
		mapOrders.put("orders", lsordersharetoRepository.findBySharetounifiedidAndSharedonBetweenAndSharestatusAndSitecode(
				objuser.getUnifieduserid(), fromdate, todate, 1,objuser.getLssitemaster().getSitecode()));

		mapOrders.put("Protocolorders",
				lsprotocolordersharetoRepository.findBySharetounifiedidAndSharedonBetweenAndSharestatusAndSitecode(
						objuser.getUnifieduserid(), fromdate, todate, 1,objuser.getLssitemaster().getSitecode()));
	...
	public Map<String, Object> Getordersinuserworkflow(LSuserMaster objuser) {
		...
		if (lstproject != null && lstworkflow != null) {
			List<LSlogilablimsorderdetail.ordersinterface> lstorders = lslogilablimsorderdetailRepository
					.findByOrderflagAndLsprojectmasterInAndLsworkflowInAndAssignedtoIsNullAndCreatedtimestampBetweenAndSitecodeOrAssignedtoAndCreatedtimestampBetweenAndSitecodeOrderByBatchcodeDesc(
							"N", lstproject, lstworkflow, fromdate, todate,objuser.getLssitemaster().getSitecode(), objuser, fromdate, todate,objuser.getLssitemaster().getSitecode());
...
//		listobjfilecode.ass
	...
	public Query globalSearchQueryprepare(String filterQuery, LSuserMaster objuser,
            List<Long> selectedTeamBatchCodeList,
            List<Integer> userCodeList) {

			String sql = "SELECT o.* FROM LSlogilablimsorderdetail o " +
			"INNER JOIN lsfile l ON l.filecode = o.lsfile_filecode " +
			"WHERE ( " +
			...
			"                WHERE lsusermaster_usercode = :userCode " +
			"            ) AND status = 1 " +
			"        ) " +
			"    ) AND (" + filterQuery + ") " +
			") OR ( " +
			"    o.filetype = 0 AND (" + filterQuery + ") " +
			") OR ( " +
			"    o.lsprojectmaster_projectcode IS NULL AND " +
			"    o.lssamplemaster_samplecode IN ( " +
			...
			"        WHERE m.lssitemaster_sitecode = :sitecode AND m.status = 1 " +
			"    ) AND (" + filterQuery + ") " +
			") OR ( " +
			"    o.lsprojectmaster_projectcode IS NULL AND " +
			"    o.viewoption = 1 AND " +
			"    o.lsusermaster_usercode = :userCode AND (" + filterQuery + ") " +
			") OR ( " +
			"    o.lsprojectmaster_projectcode IS NULL AND " +
			"    o.viewoption = 2 AND " +
			"    o.lsusermaster_usercode = :userCode AND (" + filterQuery + ") " +
			") OR ( " +
			"    o.viewoption = 3 AND " +
			"    o.lsusermaster_usercode = :userCode AND " +
			"    o.lsprojectmaster_projectcode IN ( " +
			"        SELECT lsprojectmaster_projectcode FROM LSlogilablimsorderdetail " +
			"        WHERE lsprojectmaster_projectcode IN ( " +
			"            SELECT projectcode FROM LSprojectmaster " +
			...
			") OR ( " +
			"    o.viewoption = 3 AND " +
			"    o.lsusermaster_usercode IN (:userCodes) AND " +
			"    o.teamselected = :teamfalse AND " +
			"    o.lsprojectmaster_projectcode IS NULL AND (" + filterQuery + ") " +
			") OR ( " +
			"    o.viewoption = 3 AND " +
			"    o.teamselected = :teamtrue AND " +
			"    o.batchcode IN (:selectedteambatchCodes) AND " +
			"    o.lsprojectmaster_projectcode IS NULL AND (" + filterQuery + ") " +
			") " +
			...
			query.setParameter("teamtrue", true);
			query.setParameter("teamfalse", false);
	...
	public Query globalSearchQueryprepareTotalCount(String Query, LSuserMaster objuser,
		...
		String sql = "SELECT COUNT(*) FROM LSlogilablimsorderdetail o "
				...
				+ "    AND o.teamselected = :teamfalse " + "    AND o.lsprojectmaster_projectcode IS NULL " + "    AND ("
				+ Query + ")" + ") " + "OR (" + "    o.viewoption = 3 " + "    AND o.teamselected = :teamtrue "
	...
	private Query getprotocolordercustomQueryCount(String Query, Integer usercode, List<Integer> userlist,
		 ...
		 // Extract directory codes from lstdir
	    List<Long> directoryCodes = lstdir.stream()
	        .map(Lsprotocolorderstructure::getDirectorycode) // ensure this method exists
	        .collect(Collectors.toList());
		...
		String query = "SELECT COUNT(*) FROM lslogilabprotocoldetail o "
				...
				+ "  AND o.elnmaterial_nmaterialcode IN (SELECT nmaterialcode FROM elnmaterial WHERE nsitecode = :sitecode) "
				+ "  AND (" + Query + "  )" + "  AND o.viewoption = :viewoption3 " + "  AND o.teamselected = :teamfalse "
				+ "  AND o.createby = :usercode " + "  AND o.ordercancell IS NULL" + ")" + "OR" + "("
				+ "  o.lsprojectmaster_projectcode IS NULL " + "  AND o.assignedto_usercode IS NULL "
				+ "  AND o.elnmaterial_nmaterialcode IN (SELECT nmaterialcode FROM elnmaterial WHERE nsitecode = :sitecode) "
				+ "  AND (" + Query + "  )" + "  AND o.viewoption = :viewoption3 " + "  AND o.teamselected = :teamtrue "
				...
				+ "  AND o.teamselected = :teamfalse" + "  AND o.createby IN (:userlist) "
				...
				+ "  AND o.teamselected = :teamtrue" + "  AND o.protocolordercode IN (:protocolordercode)"
...
//		        + "ORDER BY protocolordercode DESC OFFSET :offset ROWS FETCH NEXT :pageSize ROWS ONLY ";
		...
		customquery.setParameter("lstdir", directoryCodes);
...
//		customquery.setParameter("pageSize", objuser.getPageperorder());
		customquery.setParameter("teamtrue", true);
		customquery.setParameter("teamfalse", false);
		return customquery.setParameter("protocolordercode", selectedteamprotcolorderList);

	}

	private Query getprotocolordercustomQuery(String dynamicCondition, Integer usercode, List<Integer> userlist,
	        List<Lsprotocolorderstructure> lstdir, LSuserMaster objuser, List<Long> selectedteamProtocolOrderList) {
	    ...
	    // Construct the native SQL query with placeholders
	    String sql = "SELECT o.* FROM lslogilabprotocoldetail o "
	            + "INNER JOIN lsprotocolmaster l ON o.lsprotocolmaster_protocolmastercode = l.protocolmastercode "
	            ...
	            + "    AND o.elnmaterial_nmaterialcode IN (SELECT nmaterialcode FROM elnmaterial WHERE nsitecode = :sitecode) "
	            + "    AND (" + dynamicCondition + ")"
	            + "    AND o.viewoption = :viewoption3 "
	            + "    AND o.teamselected = :teamfalse "
	            + "    AND o.createby = :usercode "
	            + "    AND o.ordercancell IS NULL"
	            + "  ) OR ("
	            + "    o.lsprojectmaster_projectcode IS NULL "
	            + "    AND o.assignedto_usercode IS NULL "
	            ...
	            + "    AND (" + dynamicCondition + ")"
	            + "    AND o.viewoption = :viewoption3 "
	            + "    AND o.teamselected = :teamtrue "
	            + "    AND o.protocolordercode IN (:protocolordercode) "
	            + "    AND o.createby = :usercode "
	            + "    AND o.ordercancell IS NULL"
	            + "  )"
	            + ") OR ("
	            ...
	            + "  )"
	            + ") OR ("
	            + "  o.directorycode IN (:lstdir) "
	            + "  AND o.viewoption = :viewoption1 "
	            ...
	            + "  o.directorycode IN (:lstdir) "
	            + "  AND o.viewoption = :viewoption2 "
	            + "  AND o.lsuserMaster_usercode = :usercode "
	            + "  AND o.lsprojectmaster_projectcode IS NULL "
	            + "  AND o.assignedto_usercode IS NULL "
	            + "  AND o.ordercancell IS NULL "
	            + "  AND (" + dynamicCondition + ")"
	            ...
	            + "    AND (" + dynamicCondition + ")"
	            + "  )"
	            + ") ORDER BY protocolordercode DESC "
	            + "OFFSET :offset ROWS FETCH NEXT :pageSize ROWS ONLY";

	    // Create and bind parameters
	    Query nativeQuery = entityManager.createNativeQuery(sql, LSlogilabprotocoldetail.class);
	    nativeQuery.setParameter("usercode", objuser.getUsercode());
	    nativeQuery.setParameter("viewoption1", 1);
	    nativeQuery.setParameter("viewoption2", 2);
	    nativeQuery.setParameter("viewoption3", 3);
	    nativeQuery.setParameter("userlist", userlist);
	    nativeQuery.setParameter("lstdir", directoryCodes);
	    nativeQuery.setParameter("sitecode", objuser.getLssitemaster().getSitecode());
	    nativeQuery.setParameter("offset", objuser.getPagesize() * objuser.getPageperorder());
	    nativeQuery.setParameter("pageSize", objuser.getPageperorder());
	    nativeQuery.setParameter("teamtrue", true);
	    nativeQuery.setParameter("teamfalse", false);
	    nativeQuery.setParameter("protocolordercode", selectedteamProtocolOrderList);
...
//						BigInteger countValues = (BigInteger) querycount.getSingleResult();
						Number  countValues = (Number) querycount.getSingleResult();
...
//								objuser.getUsernotify(), objuser.getLssitemaster().getSitecode());
						lstorders = lsResults.stream()
								.map(lsOrderDetail -> new Logilabordermaster(lsOrderDetail.getBatchcode(),
										...
										lsOrderDetail.getTittle(),lsOrderDetail.getApproved(),lsOrderDetail.getPreviousapprovedworkflow(),lsOrderDetail.getWorkflowapprovedusercode()))
								.collect(Collectors.toList());
						...
						Number countValues = (Number) customquery.getSingleResult();
						count = countValues.longValue();
...
//								"%" + searchkeywords.toLowerCase() + "%", 1, 2, 3, userlist, lstdir);
						...
						lstordersprotocol = lsResults.stream()
								.map(protocolrecord -> new Logilabprotocolorders(protocolrecord.getProtocolordercode(),
										...
										protocolrecord.getSample(), protocolrecord.getLsprojectmaster(),
...
//										searchkeywords, searchkeywords);
			...
			if (objuser.getObjuser().getOrderselectiontype() == 1) {
				...
				if (testcode == -1 && objuser.getLstprojectforfilter() == null) {
					if (objuser.getObjuser().getOrderfor() == 1) {
						lstorders = LogilablimsorderdetailsRepository
								.(
										3, fromdate, todate, objuser, searchkeywords, searchkeywords, searchkeywords,
										searchkeywords, 3, fromdate, todate, objuser, searchkeywords, searchkeywords,
										directorycode, 1, fromdate, todate, searchkeywords, searchkeywords,
										searchkeywords, searchkeywords, directorycode, 1, fromdate, todate,
										searchkeywords, searchkeywords, directorycode, 2, fromdate, todate, objuser,
										searchkeywords, searchkeywords, searchkeywords, searchkeywords, directorycode,
										2, fromdate, todate, objuser, searchkeywords, searchkeywords, directorycode, 3,
										fromdate, todate, objuser, searchkeywords, searchkeywords, searchkeywords,
...
//										todate, objuser, searchkeywords, pageable));
	...
	public Map<String, Object> Getglobalsearchforsheettemplate(LSuserMaster objuser) {
		...
		if (objuser.getUsername().equals("Administrator")) {
			...
			if (lstteamuser != null && lstteamuser.size() > 0) {
				lstteamuser.add(objuser);
				usercodelist = lstteamuser.stream()
				    .map(LSuserMaster::getUsercode)
				    .collect(Collectors.toList());
				...
				// ✅ Fix: Use Number for safe casting
	...
	private Query setparametersforprotocol(Query query, Integer sitecode, boolean viewoption1, boolean viewoption2,
			boolean viewoption3, Integer usercode, List<Integer> usercodelist, boolean status, boolean count,
	...
	public Map<String, Object> Getglobalsearchforprotocoltemplate(LSuserMaster objuser) {
		...
		if (objuser.getUsername().equals("Administrator")) {
			...
			if (lstteamuser != null && lstteamuser.size() > 0) {
			    lstteamuser.add(objuser);
			    List<Integer> usercodelist = lstteamuser.stream()
			        .map(LSuserMaster::getUsercode)
			        .collect(Collectors.toList());
			    ...
			    // ✅ Fix the ClassCastException
			    Number countValue = (Number) query.getSingleResult();
...
//		Pageable pageable = PageRequest.of(objusermaster.getPagesize(), objusermaster.getPageperorder());
...
//			                filteredFiles.get(0).setFolderpath(path.getPath());
	...
	public List<LsActiveWidgets> getActivewidgetsdata(LSuserMaster objusermaster) {
		...
		lsActiveWidgetsRepository.deleteCustomRows(50, objusermaster.getUsercode(),
				objusermaster.getLssitemaster().getSitecode());
		System.out.println("After Delete --------------------------");
		List<LsActiveWidgets> rtnibj = lsActiveWidgetsRepository
				.findFirst50ByUserIdAndSitecodeOrderByActivewidgetscodeDesc(objusermaster.getUsercode(),
						objusermaster.getLssitemaster().getSitecode());
	...
	public Map<String, Object> Getoverdueprojectscountonuser(LSuserMaster objuser) throws ParseException {
		...
		if (objuser.getUsercode() != null) {
			...
			lstprojectmaster = lsprojectmasterRepository
					.findByLsusersteamInAndStatusAndEnddateLessThanOrderByProjectcodeDesc(lstteam, 1, currentdate);
			rtnobject.put("count",
					LogilablimsorderdetailsRepository.countByOrderflagAndLsprojectmasterIn("R", lstprojectmaster));
		}
		return rtnobject;
	}
