...
//	@CrossOrigin(origins = "*", allowedHeaders = "*")
	...
	public ResponseEntity<Resource> export(@RequestParam MultipartFile data, String fileName) throws Exception {
...
//	@CrossOrigin(origins = "*", allowedHeaders = "*")
	...
	public ResponseEntity<Resource> GetXLSXfile(@RequestBody SaveParameter file) throws Exception {
...
//	}
	@PostMapping(value = "/api/wordeditor/saveXLSXFile")
public Map<String, Object> saveXLSXFile(MultipartHttpServletRequest file)
       throws Exception {
   return documenteditorService.saveXLSXFile(file);
}
}
