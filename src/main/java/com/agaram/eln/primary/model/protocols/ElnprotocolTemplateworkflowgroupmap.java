...
@Entity
@Table(name = "ElnprotocolTemplateworkflowgroupmap")
public class ElnprotocolTemplateworkflowgroupmap {
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "elnprotocoltemplateworkflowgroupmap_seq")
	@SequenceGenerator(name = "elnprotocoltemplateworkflowgroupmap_seq", sequenceName = "elnprotocoltemplateworkflowgroupmap_seq", allocationSize = 1)
