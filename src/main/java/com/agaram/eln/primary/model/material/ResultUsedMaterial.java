...
public class ResultUsedMaterial {

	@Id
	@Column(name = "nresultusedmaterialcode") 
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "resultusedmaterial_nresultusedmaterialcode_seq")
	@SequenceGenerator(name = "resultusedmaterial_nresultusedmaterialcode_seq", sequenceName = "resultusedmaterial_nresultusedmaterialcode_seq", allocationSize = 1)
