...
public interface ReportDesignerStructureRepository extends JpaRepository<ReportDesignerStructure,Long> {
	...
	ReportDesignerStructure findBySitemasterAndDirectorycodeAndParentdircodeAndDirectorynameIgnoreCaseNot(
			LSSiteMaster sitemaster, Long directorycode, Long parentdircode, String directoryname);
	ReportDesignerStructure findBySitemasterAndParentdircodeAndDirectorynameIgnoreCase(LSSiteMaster sitemaster,
			Long parentdircode, String directoryname);
}
