...
public interface LsfilesharedbyRepository extends JpaRepository<Lsfilesharedby, Integer>{
	...
	List<Lsfilesharedby> findBySharebyunifiedidAndSharestatusAndSitecodeOrderBySharedbytofilecodeDesc(
			String sharebyunifiedid, int i, Integer sitecode);


	Object countBySharebyunifiedidAndSharestatusAndSitecode(String sharebyunifiedid, int i, Integer sitecode);
