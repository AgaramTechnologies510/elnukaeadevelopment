...
public interface LSprotocolfolderfilesRepository extends JpaRepository<LSprotocolfolderfiles, Integer> {
	...
	public List<LSprotocolfolderfiles> findByDirectorycodeAndFileforAndCreatedtimestampBetweenAndLssitemasterOrderByFolderfilecode(
			Long directorycode, String filefor, Date fromdate, Date todate, LSSiteMaster lssitemaster);

	@Transactional
	@Modifying
	@Query("update LSprotocolfolderfiles o set o.directorycode = ?1 where o.directorycode = ?2")
	public void updatedirectorycode(Long dircodetomove, Long directorycode);
