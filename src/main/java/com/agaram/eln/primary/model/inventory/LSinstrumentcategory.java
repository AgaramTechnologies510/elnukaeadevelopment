...
public class LSinstrumentcategory {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsinstrumentcategory_seq")
	@SequenceGenerator(name = "lsinstrumentcategory_seq", sequenceName = "lsinstrumentcategory_seq", allocationSize = 1)
