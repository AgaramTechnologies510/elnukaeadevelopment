...
@Entity
@Table(name = "LsMappedTags")
public class LsMappedTags {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsmappedtags_seq")
	@SequenceGenerator(name = "lsmappedtags_seq", sequenceName = "lsmappedtags_seq", allocationSize = 1)
