...
public class LSworkflowgroupmapping {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsworkflowgroupmapping_seq")
	@SequenceGenerator(name = "lsworkflowgroupmapping_seq", sequenceName = "lsworkflowgroupmapping_seq", allocationSize = 1)
