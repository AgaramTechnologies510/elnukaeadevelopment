...
public class LSuserMaster {
	...
	@Transient
	private LSSiteMaster activeusersite;

	public LSSiteMaster getActiveusersite() {
		return activeusersite;
	}

	public void setActiveusersite(LSSiteMaster activeusersite) {
		this.activeusersite = activeusersite;
	}
