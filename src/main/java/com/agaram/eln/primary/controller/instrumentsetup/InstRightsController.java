...
public class InstRightsController {
	...
	public ResponseEntity<Object> saveInstRights(final HttpServletRequest request, @Validated @RequestBody Map<String, Object> rightsObject)throws Exception{
	...
	public ResponseEntity<Object> getInstRightsByUser(@Validated @RequestBody Map<String, Object> userObj)throws Exception {
