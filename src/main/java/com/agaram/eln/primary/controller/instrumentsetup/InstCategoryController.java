...
public class InstCategoryController {
    ...
    public ResponseEntity<Object> createInstrumentCategory(final HttpServletRequest request, @Validated @RequestBody Map<String, Object> mapObject)throws Exception
    {
...
//       final Boolean saveAuditTrail = mapper.convertValue(mapObject.get("saveAuditTrail"), Boolean.class);
    ...
    public ResponseEntity<Object> updateInstCategory(final HttpServletRequest request, @Validated @RequestBody Map<String, Object> mapObject)throws Exception{
	 	  final ObjectMapper mapper = new ObjectMapper();
		  final InstrumentCategory category = mapper.convertValue(mapObject.get("instCategory"), InstrumentCategory.class);
    ...
    public ResponseEntity<Object> deleteInstCategory( final HttpServletRequest request, @Validated @RequestBody Map<String, Object> mapObject) throws Exception
    {
