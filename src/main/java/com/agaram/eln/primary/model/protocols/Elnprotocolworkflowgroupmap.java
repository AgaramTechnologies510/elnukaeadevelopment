...
@Entity
@Table(name = "Elnprotocolworkflowgroupmap")
public class Elnprotocolworkflowgroupmap {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "elnprotocolworkflowgroupmap_seq")
	@SequenceGenerator(name = "elnprotocolworkflowgroupmap_seq", sequenceName = "elnprotocolworkflowgroupmap_seq", allocationSize = 1)
