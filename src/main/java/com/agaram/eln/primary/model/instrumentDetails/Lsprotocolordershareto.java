...
public class Lsprotocolordershareto {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsprotocolordershareto_seq")
	@SequenceGenerator(name = "lsprotocolordershareto_seq", sequenceName = "lsprotocolordershareto_seq", allocationSize = 1)
	...
	public interface ProtocolOrderShareToInterface {
	    ...
	    String getOrderflag();
	    Integer getSitecode();
	    ProtocolOrderShareInterface getProtocolorders(); // You can replace this with a nested projection if needed
	}
