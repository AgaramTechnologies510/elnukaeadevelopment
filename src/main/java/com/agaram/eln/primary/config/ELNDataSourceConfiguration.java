...
public class ELNDataSourceConfiguration {
	...
	DataSourceProperties elnDataSourceProperties() {
    ...
    LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder) {
        ...
        factory.setPackagesToScan(new String[]{"com.agaram.eln.primary.model.*"});
    ...
    PlatformTransactionManager elnTransactionManager(
    ...
    DataSourceInitializer securityDataSourceInitializer() 
    {
        ...
        databasePopulator.addScript(new ClassPathResource("import_lsactiveuser_ls.sql"));
        if(enableinitialize)
        {
