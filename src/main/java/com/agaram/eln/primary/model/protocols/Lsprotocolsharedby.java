...
public class Lsprotocolsharedby {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsprotocolsharedby_seq")
	@SequenceGenerator(name = "lsprotocolsharedby_seq", sequenceName = "lsprotocolsharedby_seq", allocationSize = 1)
