...
public interface MaterialTypeRepository extends JpaRepository<MaterialType, Integer>{
	public MaterialType findByNmaterialtypecode(Integer nmaterialtypecode);
	...
	public List<MaterialType> findByNsitecodeOrderByNmaterialtypecodeDesc(Integer nsiteInteger);
	public List<MaterialType> findByNmaterialtypecodeNotAndNstatusAndNsitecodeAndNdefaultstatusOrderByNmaterialtypecodeDesc(
			int i, int j, Integer nsitecode, int k);
	public List<MaterialType> findByNmaterialtypecodeNotAndNsitecodeAndNdefaultstatusOrderByNmaterialtypecodeDesc(int i,
			Integer nsitecode, int j);
	public List<MaterialType> findByNmaterialtypecodeNotAndNstatusAndNsitecodeNotAndNdefaultstatusOrderByNmaterialtypecodeDesc(
			int i, int j, int k, int l);
	public List<MaterialType> findByNmaterialtypecodeNotAndNsitecodeNotAndNdefaultstatusOrderByNmaterialtypecodeDesc(
			int i, int j, int k);
} 