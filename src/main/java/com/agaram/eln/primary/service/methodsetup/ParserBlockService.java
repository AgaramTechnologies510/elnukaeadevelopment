...
public class ParserBlockService {
			...
			final LSuserMaster createdUser, final Method method)
	{
	    ...
	    final List<ParserBlock> savedList  = blockRepo.saveAll(listToSave);
	...
	{
		Method objmethod = methodrepository.findById(methodKey).orElse(null);	
