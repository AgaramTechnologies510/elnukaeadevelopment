...
@Entity(name = "Lsprotocolordersharedby")
@Table(name = "Lsprotocolordersharedby")
public class Lsprotocolordersharedby {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsprotocolordersharedby_seq")
	@SequenceGenerator(name = "lsprotocolordersharedby_seq", sequenceName = "lsprotocolordersharedby_seq", allocationSize = 1)
	@Basic(optional = false)
	@Column(name = "sharedbytoprotocolordercode")
	...
	public interface ProtocolShareByInterface {

	    Long getSharedbytoprotocolordercode();
	    Long getSharetoprotocolordercode();
	    String getSharebyunifiedid();
	    String getSharetounifiedid();
	    String getSharebyusername();
	    String getSharetousername();
	    Long getShareprotocolordercode();
	    String getShareprotoclordername();
	    ...
	    String getOrderflag();
	    Integer getSitecode();
	    ProtocolOrderShareInterface getProtocolorders();
	}
