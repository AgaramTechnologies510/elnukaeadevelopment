...
//				System.out.println(jsonContent);
			...
			String jsonContent=new BufferedReader(new InputStreamReader(resource.getInputStream(), StandardCharsets.UTF_8))
...
//	}
	...
	public ReportDesignerStructure insertdirectory(ReportDesignerStructure objdir) {
		...
		if (objdir.getDirectorycode() != null) {
			lstdir = reportDesignerStructureRepository.findBySitemasterAndDirectorycodeAndParentdircodeAndDirectorynameIgnoreCaseNot(
					objdir.getSitemaster(),objdir.getDirectorycode(), objdir.getParentdircode(), objdir.getDirectoryname());
		} else {
			lstdir = reportDesignerStructureRepository.findBySitemasterAndParentdircodeAndDirectorynameIgnoreCase(objdir.getSitemaster(),objdir.getParentdircode(),
		...
		if (objdir.getFilefor().equals("RDT") || objdir.getFilefor().equals("RAT")) {
			...
			if(searchKeyword != null && searchKeyword.equals("")
				...
				lsttemplate = reporttemplaterepository
						.findBySitemasterAndViewoptionAndTemplatetypeAndDateCreatedBetweenOrSitemasterAndViewoptionAndTemplatetypeAndCreatedbyAndDateCreatedBetweenOrSitemasterAndViewoptionAndTemplatetypeAndCreatedbyInAndDateCreatedBetweenOrderByTemplatecodeDesc(
								objdir.getSitemaster(), 1, objdir.getTemplatetype(),
					...
					&& searchtemplatename != null && searchtemplatename.equals("")) {
				lsttemplate = reporttemplaterepository
						.(
								objdir.getSitemaster(), 1, objdir.getTemplatetype(),
					...
					&& searchtemplatename != null && !searchtemplatename.equals("")) {
				lsttemplate = reporttemplaterepository
						.(
								objdir.getSitemaster(), 1, objdir.getTemplatetype(),
					...
					&& searchtemplatename != null && !searchtemplatename.equals("")) {
				lsttemplate = reporttemplaterepository
						.(
								objdir.getSitemaster(), 1, objdir.getTemplatetype(),
			...
			if (objdir.getTemplatetype() == -1 && searchKeyword != null && searchKeyword.equals("")
					&& searchtemplatename != null && searchtemplatename.equals("")) {
				lsttemplate = reporttemplaterepository
						.(
								objdir.getSitemaster(), 1, objdir.getFromdate(),
					...
					&& searchtemplatename != null && searchtemplatename.equals("")) {
				lsttemplate = reporttemplaterepository
						.(
								objdir.getSitemaster(), 1, objdir.getTemplatetype(),
...
//				lsttemplate = reporttemplaterepository.findByKeywordContainingIgnoreCase("s");
				...
				lsttemplate = reporttemplaterepository
						.(
								objdir.getSitemaster(), 1, objdir.getFromdate(),
					...
					&& searchtemplatename != null && !searchtemplatename.equals("")) {
				lsttemplate = reporttemplaterepository
						.(
								objdir.getSitemaster(), 1, objdir.getFromdate(),
				...
				lsttemplate = reporttemplaterepository
						.(
								objdir.getSitemaster(), 1, objdir.getFromdate(),
					...
					&& searchtemplatename != null && !searchtemplatename.equals("")) {
				lsttemplate = reporttemplaterepository
						.(
								objdir.getSitemaster(), 1, objdir.getTemplatetype(),
				...
				lsttemplate = reporttemplaterepository
						.(
								objdir.getSitemaster(), 1,
					...
					&& searchtemplatename != null && !searchtemplatename.equals("")) {
				lsttemplate = reporttemplaterepository
						.(
								objdir.getSitemaster(), 1, objdir.getTemplatetype(),
								objdir.getFromdate(), objdir.getTodate(), objdir, searchKeyword, searchtemplatename,
		...
		for (LSprotocolstep LSprotocolstepObj1 : LSprotocolsteplst) {
			if (multitenent == 1) {
				LSprotocolstepInformation newobj = lsprotocolstepInformationRepository
						.findById(LSprotocolstepObj1.getProtocolstepcode()).orElse(null);
...
//		reporttemplaterepository.save(objdir);
		...
		reportTemplateMappingRepository.saveAll(objdir.getReportTemplateMappings());
		return objdir;
	}
	...
	@SuppressWarnings("resource")
	public ReportTemplateVersion gettemplateversiondata(ReportTemplateVersion objfile) throws IllegalStateException, IOException {
		if (objfile.getIsmultitenant() == 1 || objfile.getIsmultitenant() == 2) {
			String tenant = TenantContext.getCurrentTenant();
			if (objfile.getIsmultitenant() == 2) {
				tenant = "freeusers";
	...
	public List<ReportDesignerStructure> DeletedirectoriesonReportDesigner(ReportDesignerStructure[] directories) {
		...
		lstdirectories.forEach(structure -> {
			if (structure.getParentdircode() == -2) {
				reportDesignerStructureRepository.deleteById(structure.getDirectorycode());
	...
	public List<Reporttemplate> ReportTemplateget(Map<String, Object> mapObject) {
	...
	public List<Reporttemplate> MoveReportTemplate(Reporttemplate[] template) {
		...
		rttemplate = rttemplate.stream().peek(item->{
			try {
				item.setDateModified(commonfunction.getCurrentUtcTime());
		...
		List<Long> lstfilesid = rttemplate.stream().map(Reporttemplate::getTemplatecode)
				.collect(Collectors.toList());
		reporttemplaterepository.updateTemplateDetailsMove(lstfilesid,rttemplate.get(0).getDircodetomove(),rttemplate.get(0).getModifieduser());
