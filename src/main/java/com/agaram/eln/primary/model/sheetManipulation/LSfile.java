...
//	@Column(columnDefinition = "date")
	...
	public LSfile(Integer filecode, String filenameuser,Integer versionno) {
		this.filecode = filecode;
		this.filenameuser = filenameuser;
	...
	@ManyToOne
	private LSsheetworkflow previousapprovedworkflow;
	...
	public LSsheetworkflow getPreviousapprovedworkflow() {
		return previousapprovedworkflow;
	}

	public void setPreviousapprovedworkflow(LSsheetworkflow previousapprovedworkflow) {
