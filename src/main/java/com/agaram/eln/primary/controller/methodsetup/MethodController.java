...
public class MethodController {
	...
	public ResponseEntity<Object> getmethodversion(@Validated @RequestBody Map<String, Object> mapObject) throws Exception {
//		final ObjectMapper mapper = new ObjectMapper();
...
//		final Boolean saveAuditTrail = mapper.convertValue(mapObject.get("saveAuditTrail"), Boolean.class);
	 ...
	 */
	@PostMapping(value = {"/updateMethodStatus", "/updateParserSetupStatus"})
...
//				  saveAuditTrail, request);
	...
	public ResponseEntity<Object> getInstListToAssociateMethod(@Validated @RequestBody Map<String, LSSiteMaster> siteObj)
			throws Exception {
	...
	public String getFileData(@Validated @RequestBody Map<String, Object> mapObject) throws Exception {
...
//	}
	...
	public ResponseEntity<Object> getMethodByEquipment(@Validated @RequestBody Map<String, Object> mapObject)
			throws Exception {
		final ObjectMapper mapper = new ObjectMapper();
		final Method method = mapper.convertValue(mapObject.get("method"), Method.class);
