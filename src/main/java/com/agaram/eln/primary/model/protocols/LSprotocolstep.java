...
public class LSprotocolstep {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsprotocolstep_seq")
	@SequenceGenerator(name = "lsprotocolstep_seq", sequenceName = "lsprotocolstep_seq", allocationSize = 1)
