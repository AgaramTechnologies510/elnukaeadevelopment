...
//	List<Equipment> findByEquipmentcategoryAndNstatus(EquipmentCategory equicat, int i);
	...
	Equipment findByNequipmentcode(Integer nequipmentcode);

	List<Equipment> findByNsitecodeAndNstatusAndEquipmentusedAndCreateddateBetweenOrderByNequipmentcodeDesc(
			Integer nsiteInteger, int i, boolean b, Date fromDate, Date toDate);

	List<Equipment> findByEquipmentcategoryAndNstatusAndEquipmentusedAndNsitecodeAndCreateddateBetweenOrderByNequipmentcodeDesc(
			EquipmentCategory objCategory, int i, boolean b, Integer nsiteInteger, Date fromDate, Date toDate);

	List<Equipment> findByEquipmenttypeAndNstatusAndEquipmentusedAndNsitecodeAndCreateddateBetweenOrderByNequipmentcodeDesc(
			EquipmentType objType, int i, boolean b, Integer nsiteInteger, Date fromDate, Date toDate);

	List<Equipment> findByEquipmenttypeAndNstatusAndEquipmentusedAndEquipmentcategoryAndNsitecodeAndCreateddateBetweenOrderByNequipmentcodeDesc(
			EquipmentType objType, int i, boolean b, EquipmentCategory objCategory, Integer nsiteInteger, Date fromDate,
			Date toDate);

	List<Equipment> findByNsitecodeAndCreateddateBetweenAndEquipmentusedOrderByNequipmentcodeDesc(
			Integer nsiteInteger, Date fromDate, Date toDate, boolean b);

	List<Equipment> findByNsitecodeAndCreateddateBetweenAndEquipmentusedAndNstatusOrderByNequipmentcodeDesc(
			Integer nsiteInteger, Date fromDate, Date toDate, boolean b, int i);
