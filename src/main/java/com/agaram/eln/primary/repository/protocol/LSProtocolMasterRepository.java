...
public interface LSProtocolMasterRepository extends JpaRepository<LSprotocolmaster, Integer> {
	...
	@Transactional
	@Modifying
	@Query("update LSprotocolmaster set elnprotocoltemplateworkflow = :workflow, approved= :approved , rejected= :rejected ,previousapprovedworkflow= :elnprotocolTemplateworkflow , workflowapprovedusercode= :integer "
	...
	public void updateFileWorkflow(@Param("workflow") ElnprotocolTemplateworkflow lSsheetworkflow,
			...
			@Param("protocolmastercode") Integer protocolmastercode,@Param("elnprotocolTemplateworkflow") ElnprotocolTemplateworkflow elnprotocolTemplateworkflow,@Param("integer") Integer integer);
	...
	long (
			ElnprotocolTemplateworkflow objflow, int i, int j, int k, ElnprotocolTemplateworkflow objflow2, int l,
			int m, ElnprotocolTemplateworkflow objflow3, int n, int o, ElnprotocolTemplateworkflow objflow4, int p);
	
	@Transactional
	@Modifying
	@Query(value = "update LSprotocolmaster set elnprotocoltemplateworkflow_workflowcode = ?1 where elnprotocoltemplateworkflow_workflowcode is null and lssitemaster_sitecode = ?2 and protocolmastercode in(?3)", nativeQuery = true)
	void updateElnprotocoltemplateworkflow(int workflowcode, Integer sitecode, List<Integer> protocolcodes);

	long countByLssitemasterAndElnprotocoltemplateworkflowIsNullAndApprovedIsNullAndRejectedIsNullAndRetirestatus(
			Integer sitecode, int i);

	List<LSprotocolmaster> findByLssitemasterAndElnprotocoltemplateworkflowIsNullAndApprovedIsNullAndRejectedIsNullAndRetirestatus(
			Integer sitecode, int i);

	LSprotocolmaster findByProtocolmastername(String protocolname);


	List<LSprotocolmaster> (
			Integer sitecode, List<LSprotocolmastertest> lsfiletest, int i, int j, int k, int l,
			List<Integer> lstteammap, List<LSprotocolmastertest> lsfiletest2, int m, int n, int o, int p,
			Integer usercode, List<LSprotocolmastertest> lsfiletest3, int q, int r, int s, int t,
			List<Integer> lstteammap2, List<LSprotocolmastertest> lsfiletest4, int u, int v, int w, int x);

	List<LSprotocolmaster> (
			Integer sitecode, List<LSprotocolmastertest> lsfiletest, int i, int j, int k, List<Integer> lstteammap,
			List<LSprotocolmastertest> lsfiletest2, int l, int m, int n, Integer usercode,
			List<LSprotocolmastertest> lsfiletest3, int o, int p, int q, List<Integer> lstteammap2,
			List<LSprotocolmastertest> lsfiletest4, int r, int s, int t);
}