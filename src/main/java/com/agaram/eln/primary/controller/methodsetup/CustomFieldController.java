...
public class CustomFieldController {
	...
	public ResponseEntity<Object> getCustomFieldByMethod(@Validated @RequestBody Map<String, Object> mapObject)throws Exception {	
	...
	/**
	  ...
	  public ResponseEntity<Object> createCustomField(final HttpServletRequest request, @Validated @RequestBody Map<String, Object> mapObject)throws Exception {
		  final ObjectMapper mapper = new ObjectMapper();		
...
//		  final Page page = mapper.convertValue(mapObject.get("modulePage"), Page.class);
	  ...
	  public ResponseEntity<Object> updateCustomField(final HttpServletRequest request, @Validated @RequestBody Map<String, Object> mapObject)throws Exception {
		  final ObjectMapper mapper = new ObjectMapper();	
		  final CustomField customField = mapper.convertValue(mapObject.get("customfield"), CustomField.class);
		  final Boolean saveAuditTrail = mapper.convertValue(mapObject.get("saveAuditTrail"), Boolean.class);
		 // final Page page = mapper.convertValue(mapObject.get("modulePage"), Page.class);
	  ...
	  public ResponseEntity<Object> deleteCustomField(final HttpServletRequest request, @Validated @RequestBody Map<String, Object> mapObject)throws Exception {
		  final ObjectMapper mapper = new ObjectMapper();	
