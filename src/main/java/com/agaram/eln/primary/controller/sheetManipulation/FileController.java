...
public class FileController {
	...
	public LSfile InsertupdateSheet(MultipartHttpServletRequest objfile)throws Exception {
...
//	}
	...
	@PostMapping("/GetSheetsbyuseronDetailview")
	public Map<String, Object> GetSheetsbyuseronDetailview(@RequestBody LSuserMaster objuser)throws Exception {
		return fileService.GetSheetsbyuseronDetailview(objuser);
	}
	...
	@PostMapping("/unlockorderOnViewClose")
	...
	@PostMapping("/Getelnsheetmappedtest")
	public LSfiletest Getelnsheetmappedtest(@RequestBody LSfile lsfile)
	{
		return fileService.Getelnsheetmappedtest(lsfile);
	}
	
	@PostMapping("/updatetSheetTemplateTransactionlislist")
	public List<LSsheetupdates> updatetSheetTemplateTransactionlislist(@RequestBody List<LSsheetupdates> objSheetupdatets) {
	    return fileService.updatetSheetTemplateTransactionlislist(objSheetupdatets);
	}
	
	@PostMapping("/updatetprotocolTransactionlislist")
	public List<LSprotocolupdates> updatetprotocolTransactionlislist(@RequestBody List<LSprotocolupdates> objLSprotocolupdates) {
	    return fileService.updatetprotocolTransactionlislist(objLSprotocolupdates);
	}
