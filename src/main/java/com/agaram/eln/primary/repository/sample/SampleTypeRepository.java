...
public interface SampleTypeRepository extends JpaRepository<SampleType,Integer> {
	...
	List<SampleType> findByNsampletypecodeNotAndNstatusAndNsitecodeOrNsampletypecodeNotAndNstatusAndNdefaultstatusOrderByNsampletypecodeDesc(
			int i, int j, Integer nsitecode, int k, int l, int m);

	List<SampleType> findByNsampletypecodeNotAndNsitecodeNotAndNdefaultstatusOrderByNsampletypecodeDesc(int i, int j,
			int k);

	List<SampleType> findByNsampletypecodeNotAndNsitecodeAndNdefaultstatusOrderByNsampletypecodeDesc(int i,
			Integer nsitecode, int j);

	List<SampleType> findByNsampletypecodeNotAndNstatusAndNsitecodeNotAndNdefaultstatusOrderByNsampletypecodeDesc(int i,
			int j, int k, int l);

	List<SampleType> findByNsampletypecodeNotAndNstatusAndNsitecodeAndNdefaultstatusOrderByNsampletypecodeDesc(int i,
			int j, Integer nsitecode, int k);
