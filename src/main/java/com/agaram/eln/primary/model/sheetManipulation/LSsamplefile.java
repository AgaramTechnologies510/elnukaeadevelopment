...
public class LSsamplefile {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lssamplefile_filesamplecode_seq")
	@SequenceGenerator(name = "lssamplefile_filesamplecode_seq", sequenceName = "lssamplefile_filesamplecode_seq", allocationSize = 1)
