...
@Entity(name = "elnfileattachments")
@Table(name = "elnfileattachments")
public class ELNFileAttachments {
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "elnfileattachments_seq")
	@SequenceGenerator(name = "elnfileattachments_seq", sequenceName = "elnfileattachments_seq", allocationSize = 1)
