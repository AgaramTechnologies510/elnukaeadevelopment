...
public class ReportsVersion {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "reportsversion_seq")
	@SequenceGenerator(name = "reportsversion_seq", sequenceName = "reportsversion_seq", allocationSize = 1)
