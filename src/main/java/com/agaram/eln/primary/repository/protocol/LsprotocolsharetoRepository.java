...
//	Long countBySharetounifiedidAndSharestatusOrderBySharetoprotocolcodeDesc(String sharetounifiedid, int i);
	...
	List<Lsprotocolshareto> findBySharetounifiedidAndSharestatusAndSitecodeOrderBySharetoprotocolcodeDesc(
			String sharetounifiedid, int i, Integer sitecode);


	Long countBySharetounifiedidAndSharestatusAndSitecodeOrderBySharetoprotocolcodeDesc(String sharetounifiedid,
			int i, Integer sitecode);


	Lsprotocolshareto findBySharebyunifiedidAndSharetounifiedidAndShareprotocolcodeAndSharerights(
			String sharebyunifiedid, String sharetounifiedid, Long shareprotocolcode, int sharerights);
