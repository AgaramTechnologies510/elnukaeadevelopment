...
public interface ReportViewerStructureRepository extends JpaRepository<ReportViewerStructure,Long> {
	...
	ReportViewerStructure findBySitemasterAndDirectorycodeAndParentdircodeAndDirectorynameNot(LSSiteMaster sitemaster,
			Long directorycode, Long parentdircode, String directoryname);
	ReportViewerStructure findBySitemasterAndParentdircodeAndDirectoryname(LSSiteMaster sitemaster, Long parentdircode,
			String directoryname);
}
