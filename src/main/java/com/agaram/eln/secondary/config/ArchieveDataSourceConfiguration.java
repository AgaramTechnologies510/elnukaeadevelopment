...
public class ArchieveDataSourceConfiguration {
	...
	DataSourceProperties archieveDataSourceProperties() {
	...
	LocalContainerEntityManagerFactoryBean archiveEntityManagerFactory(
...
//	                .build();
	...
	PlatformTransactionManager archiveTransactionManager(
