...
public interface LSaudittrailconfigurationRepository extends JpaRepository<LSaudittrailconfiguration, AudittrailconfigurationId> {
	public List<LSaudittrailconfiguration> findByLsusermasterOrderByOrdersequnce(LSuserMaster lsusermaster);
	
	public List<LSaudittrailconfiguration> findByLssitemasterOrderByAuditcofigcodeDesc(LSSiteMaster lssitemaster);
