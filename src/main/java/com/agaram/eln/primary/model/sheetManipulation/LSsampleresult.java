...
public class LSsampleresult {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lssampleresult_seq")
	@SequenceGenerator(name = "lssampleresult_seq", sequenceName = "lssampleresult_seq", allocationSize = 1)
