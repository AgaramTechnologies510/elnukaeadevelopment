...
public class LSPasswordPolicy {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lspasswordpolicy_seq")
	@SequenceGenerator(name = "lspasswordpolicy_seq", sequenceName = "lspasswordpolicy_seq", allocationSize = 1)
