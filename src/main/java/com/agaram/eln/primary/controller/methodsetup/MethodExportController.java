...
@RestController
@RequestMapping(value = "/MethodExportController", method = RequestMethod.POST)
...
public class MethodExportController {
	...
	public ResponseEntity<Object> getAllByMethod(@Validated @RequestBody Map<String, Object> mapObject) throws  Exception {
