...
public class LSparsedparameters {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsparsedparameters_seq")
	@SequenceGenerator(name = "lsparsedparameters_seq", sequenceName = "lsparsedparameters_seq", allocationSize = 1)
