...
INSERT into lsusermaster(userfullname, username, password, lastloggedon, passwordexpirydate, userstatus, lockcount, createddate, modifieddate, createdby, modifiedby, labsheet, emailid, profileimage, profileimagename, verificationcode, lssitemaster_sitecode,loginfrom,userretirestatus) VALUES (N'Administrator', N'Administrator', NULL, CAST(N'2020-03-18T18:57:44.127' AS date), NULL, N'A         ', 0, CAST(N'2020-01-21T18:35:23.080' AS date), NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, 1,'0',0)
...
insert into LSsheetworkflow (workflowname,lssitemaster_sitecode)values('New',1)
...
insert into LSCFRReasons(comments,lssitemaster_sitecode,createddate,status,createdby_usercode) values ('Reviewed',1,NOW(),1,1)
insert into LSCFRReasons(comments,lssitemaster_sitecode,createddate,status,createdby_usercode) values ('Declained',1,NOW(),1,1)
...
insert into LSpasswordpolicy (policycode, complexpasswrd, dbbased, lockpolicy, maxpasswrdlength, mincapitalchar, minnumericchar, minpasswrdlength,minsmallchar,minspecialchar,passwordexpiry,passwordhistory,lssitemaster_sitecode,idletime,idletimeshowcheck) VALUES (1,0,null,5, 10,0,0, 4,0,0, 90, 5,1,15,1)

insert into lsmultiusergroup (usercode,defaultusergroup,lsusergroup_usergroupcode)values(1,1,1)

insert into parsermethod ( parsermethodname, parsermethodtype) values ( N'Datablock', 1) 
insert into parsermethod ( parsermethodname, parsermethodtype) values ( N'Beginrowmatch', 1) 
insert into parsermethod ( parsermethodname, parsermethodtype) values ( N'rowmatch', 1) 
insert into parsermethod ( parsermethodname, parsermethodtype) values ( N'colmatch', 1) 
insert into parsermethod ( parsermethodname, parsermethodtype) values ( N'None', 2) 
insert into parsermethod ( parsermethodname, parsermethodtype) values ( N'Merge', 2) 
insert into parsermethod ( parsermethodname, parsermethodtype) values ( N'Split', 2) 
insert into parsermethod ( parsermethodname, parsermethodtype) values ( N'Shift', 2) 

insert into instrumenttype(insttypename,status) values('File',1) 
insert into instrumenttype(insttypename,status) values('RS232',1) 
insert into instrumenttype(insttypename,status) values('TCP/IP',1) 