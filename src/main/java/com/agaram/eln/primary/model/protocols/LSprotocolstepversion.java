...
public class LSprotocolstepversion implements Comparable<LSprotocolstepversion>{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsprotocolstepversion_seq")
	@SequenceGenerator(name = "lsprotocolstepversion_seq", sequenceName = "lsprotocolstepversion_seq", allocationSize = 1)
