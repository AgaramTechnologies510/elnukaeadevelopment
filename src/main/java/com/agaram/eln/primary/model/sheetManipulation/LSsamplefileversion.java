...
public class LSsamplefileversion {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lssamplefileversion_filesamplecodeversion_seq")
	@SequenceGenerator(name = "lssamplefileversion_filesamplecodeversion_seq", sequenceName = "lssamplefileversion_filesamplecodeversion_seq", allocationSize = 1)
