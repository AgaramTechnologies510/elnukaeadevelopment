...
public class Elnmaterial implements Serializable{
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "elnmaterial_nmaterialcode_seq")
	@SequenceGenerator(name = "elnmaterial_nmaterialcode_seq", sequenceName = "elnmaterial_nmaterialcode_seq", allocationSize = 1)
...
//	private Boolean barcode;
	...
	@Column(name = "smaterialname", length = 150)
