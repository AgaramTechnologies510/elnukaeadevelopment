...
public class GeneralFieldController {
	...
	public ResponseEntity<Object> getGeneralFieldBySite(@Validated @RequestBody Map<String, Object> mapObject)throws Exception {	
	...
	/**
	  ...
	  public ResponseEntity<Object> createGeneralField(final HttpServletRequest request, @Validated @RequestBody Map<String, Object> mapObject)throws Exception {
		  final ObjectMapper mapper = new ObjectMapper();		
	  ...
	  public ResponseEntity<Object> updateGeneralField(final HttpServletRequest request, @Validated @RequestBody Map<String, Object> mapObject)throws Exception {
		  final ObjectMapper mapper = new ObjectMapper();	
		  final GeneralField generalField = mapper.convertValue(mapObject.get("generalfield"), GeneralField.class);
		  final Boolean saveAuditTrail = mapper.convertValue(mapObject.get("saveAuditTrail"), Boolean.class);
	  ...
	  public ResponseEntity<Object> deleteGeneralField(final HttpServletRequest request, @Validated @RequestBody Map<String, Object> mapObject)throws Exception {
		  final ObjectMapper mapper = new ObjectMapper();	
