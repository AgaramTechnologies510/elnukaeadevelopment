...
public class Logilaborders extends Logilabordermaster {
	...
	public Logilaborders(Long batchcode, String batchid, String orderflag, Integer approvelstatus,
			...
			Boolean teamselected,String sequenceid,String tittle,Integer sheetversionno,LSworkflow previousapprovedworkflow,Integer workflowapprovedusercode,Boolean isclone) {
		...
		super(batchcode, batchid, lsworkflow, testname, lsfile, lssamplemaster, lsprojectmaster, filetype, orderflag,assignedto, createdtimestamp,completedtimestamp,keyword,
				...
				lsautoregisterorders,sentforapprovel,approvelaccept,autoregistercount, elnmaterial,teamselected,sequenceid,tittle,approved,previousapprovedworkflow,workflowapprovedusercode);
		...
		this.lsprojectmaster =lsprojectmaster!=null?new LSprojectmaster(lsprojectmaster.getCreatedby(),lsprojectmaster.getProjectcode(),lsprojectmaster.getProjectname(),lsprojectmaster.getProjectstatus(), lsprojectmaster.getStatus(),lsprojectmaster.getTeamname(),lsprojectmaster.getProjectid()):lsprojectmaster;
        ...
        this.tittle=tittle;
        this.sheetversionno = sheetversionno != null ? sheetversionno : null;
