...
public class LSfiletest {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsfiletest_seq")
	@SequenceGenerator(name = "lsfiletest_seq", sequenceName = "lsfiletest_seq", allocationSize = 1)
