...
public class SampleCategoryService {
	...
	public ResponseEntity<Object> getSampleType(Integer nsitecode) {
		...
		List<SampleType> lstgetSampleType = nsitecode.equals(0) 
				? sampleTypeRepository.findByNsampletypecodeNotAndNstatusAndNsitecodeNotAndNdefaultstatusOrderByNsampletypecodeDesc(
						-1, 1, -1, 3)
				: sampleTypeRepository.findByNsampletypecodeNotAndNstatusAndNsitecodeAndNdefaultstatusOrderByNsampletypecodeDesc(
						-1,	1, nsitecode, 3);
	...
	public ResponseEntity<Object> getSampleCategory(Integer nsitecode) {
		...
		List<SampleCategory> lstgetSampleCategory = nsitecode.equals(0) 
				? sampleCategoryRepository.findByNsitecodeNotAndNdefaultstatusOrderByNsamplecatcodeDesc(-1, 4)
				: sampleCategoryRepository.findByNsitecodeAndNdefaultstatusOrderByNsamplecatcodeDesc(nsitecode, 4);
