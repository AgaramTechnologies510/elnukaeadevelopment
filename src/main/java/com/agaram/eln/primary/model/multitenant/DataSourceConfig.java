...
public class DataSourceConfig implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "datasourceconfig_seq")
	@SequenceGenerator(name = "datasourceconfig_seq", sequenceName = "datasourceconfig_seq", allocationSize = 1)
	private Long id;
	private String name;
	private String url;
