...
public class ParserSetupController {
	...
	public ResponseEntity<Object> getParserData(@Validated @RequestBody Map<String, Object> mapObject)throws Exception
	{    	
	...
	public ResponseEntity<Object> getversionParserData(@Validated @RequestBody Map<String, Object> mapObject)throws Exception
	{    	
		//final int methodKey = (Integer) mapObject.get("methodKey");
        Map<String, Object> obj = (Map<String, Object>) mapObject.get("inputData");
