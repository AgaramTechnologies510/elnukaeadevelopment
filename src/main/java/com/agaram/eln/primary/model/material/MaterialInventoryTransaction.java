...
public class MaterialInventoryTransaction {
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "materialinventorytransaction_nmaterialinventtranscode_seq")
	@SequenceGenerator(name = "materialinventorytransaction_nmaterialinventtranscode_seq", sequenceName = "materialinventorytransaction_nmaterialinventtranscode_seq", allocationSize = 1)
