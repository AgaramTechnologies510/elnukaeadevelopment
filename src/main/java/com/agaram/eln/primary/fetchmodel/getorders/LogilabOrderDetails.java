...
public class LogilabOrderDetails extends Logilaborders {
 ...
 //   private Lsordershareto sharetome;
    private LsordersharetoProjection sharetome;
	...
	public LogilabOrderDetails(Long batchcode, String batchid, String orderflag, Integer approvelstatus,
			...
			String approvelaccept,Integer autoregistercount,Boolean teamselected,String sequenceid,String tittle,Integer sheetversionno,LSworkflow previousapprovedworkflow,
			Integer workflowapprovedusercode,Boolean isclone
		...
		super(batchcode, batchid, orderflag, approvelstatus, lockeduser, testcode, testname, lssamplemaster,
				...
				repeat, lsautoregisterorders, sentforapprovel, approvelaccept, autoregistercount,teamselected,sequenceid,tittle,sheetversionno, previousapprovedworkflow, workflowapprovedusercode,isclone);
	...
	public LsordersharetoProjection getSharetome() {
		return sharetome;
	}

	public void setSharetome(LsordersharetoProjection sharetome) {
