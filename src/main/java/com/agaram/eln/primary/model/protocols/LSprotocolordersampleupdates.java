...
public class LSprotocolordersampleupdates {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsprotocolordersampleupdates_seq")
	@SequenceGenerator(name = "lsprotocolordersampleupdates_seq", sequenceName = "lsprotocolordersampleupdates_seq", allocationSize = 1)
