...
public class LSprotocolmaster implements Comparable<LSprotocolmaster> {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsprotocolmaster_seq")
	@SequenceGenerator(name = "lsprotocolmaster_seq", sequenceName = "lsprotocolmaster_seq", allocationSize = 1)
	...
	@ManyToOne
	private ElnprotocolTemplateworkflow previousapprovedworkflow;
	
	private Integer workflowapprovedusercode;

	public ElnprotocolTemplateworkflow getPreviousapprovedworkflow() {
		return previousapprovedworkflow;
	}

	public void setPreviousapprovedworkflow(ElnprotocolTemplateworkflow previousapprovedworkflow) {
