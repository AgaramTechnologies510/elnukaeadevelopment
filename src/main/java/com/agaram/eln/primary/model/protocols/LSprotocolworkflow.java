...
public class LSprotocolworkflow {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsprotocolworkflow_seq")
	@SequenceGenerator(name = "lsprotocolworkflow_seq", sequenceName = "lsprotocolworkflow_seq", allocationSize = 1)
