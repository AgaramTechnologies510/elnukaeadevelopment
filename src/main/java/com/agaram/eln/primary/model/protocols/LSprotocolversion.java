...
public class LSprotocolversion implements Comparable<LSprotocolversion>{
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsprotocolversion_seq")
	@SequenceGenerator(name = "lsprotocolversion_seq", sequenceName = "lsprotocolversion_seq", allocationSize = 1)
