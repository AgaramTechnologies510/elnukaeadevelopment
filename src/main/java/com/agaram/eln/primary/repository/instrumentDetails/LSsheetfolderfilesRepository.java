...
public List<LSsheetfolderfiles> findByDirectorycodeAndLssitemasterAndFileforAndCreatedtimestampBetweenOrderByFolderfilecode(
		Long directorycode, LSSiteMaster lssitemaster, String filefor, Date fromdate, Date todate);

@Transactional
@Modifying
@Query("update LSsheetfolderfiles o set o.directorycode = ?1 where o.directorycode = ?2")
public void updatedirectorycode(Long directorycode, Long parentdircode);
