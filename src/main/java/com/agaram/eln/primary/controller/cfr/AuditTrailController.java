...
public class AuditTrailController {
	...
	@GetMapping("/GetActiveReasons")
	public List<LScfrreasons> GetActiveReasons(@RequestBody Map<String, Object> objMap) throws Exception {
		return auditService.GetActiveReasons(objMap);
	}
	...
	public Map<String, Object> exportDataFile(@RequestBody LSuserMaster objuser) throws Exception {
		...
		if (objuser.getObjuser() != null) {
			...
			List<LSuserMaster> userClass = LoginService.CheckUserAndPassword(objuser.getObjuser());

			if (userClass.get(0).getObjResponse().getStatus()) {
	...
	@PostMapping("/beforloginsilentandmanualRecordHandler")
	public LScfttransaction beforloginsilentandmanualRecordHandler(@RequestBody Map<String, Object> mapObj)
			throws ParseException {
		return auditService.beforloginsilentandmanualRecordHandler(mapObj);
	}
}
