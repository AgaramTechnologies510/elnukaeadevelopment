...
@RestController
@RequestMapping(value = "/DashBoardDemo", method = RequestMethod.POST)
public class DashBoardDemoController {
	...
	@PostMapping("/Getglobalsearchfolder")
	...
	@PostMapping("/Getglobalsearchforfile")
	...
	@PostMapping("/Getglobalsearchforlogbook")
	...
	@PostMapping("/Getglobalsearchforinventory")
	...
	@PostMapping("/getActivewidgetsdata")
	...
	@PostMapping("/Onsaveactivewidgetsdata")
