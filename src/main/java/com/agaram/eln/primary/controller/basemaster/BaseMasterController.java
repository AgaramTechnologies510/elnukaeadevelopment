...
public class BaseMasterController {
	...
	@PostMapping("/getAllSampleMaster")
	...
	@PostMapping("/getProjectmasteronproject")
	...
	@PostMapping("/getActiveProjectmaster")
	public List<LSprojectmaster> getActiveProjectmaster(@RequestBody LSuserMaster objClass)throws Exception {
		return masterService.getActiveProjectmaster(objClass);
	}
	...
	@PostMapping("/getLsrepositoriesLst")
	...
	@PostMapping("/getLsrepositoriesDataLst")
	...
	@PostMapping("/logbooksampleupdates")
