...
public class LSprotocolordervideos {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsprotocolordervideos_seq")
	@SequenceGenerator(name = "lsprotocolordervideos_seq", sequenceName = "lsprotocolordervideos_seq", allocationSize = 1)
