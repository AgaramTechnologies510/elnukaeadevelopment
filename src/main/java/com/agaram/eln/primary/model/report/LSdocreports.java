...
public class LSdocreports {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsdocreports_seq")
	@SequenceGenerator(name = "lsdocreports_seq", sequenceName = "lsdocreports_seq", allocationSize = 1)
