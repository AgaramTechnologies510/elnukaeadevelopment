...
public class LStestmasterlocal {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lstestmasterlocal_seq")
	@SequenceGenerator(name = "lstestmasterlocal_seq", sequenceName = "lstestmasterlocal_seq", allocationSize = 1)
