...
public class ElnmaterialInventory {
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "elnmaterialinventory_nmaterialinventorycode_seq")
	@SequenceGenerator(name = "elnmaterialinventory_nmaterialinventorycode_seq", sequenceName = "elnmaterialinventory_nmaterialinventorycode_seq", allocationSize = 1)
	...
	@OrderBy("nresultusedmaterialcode DESC")	
