...
public class Equipment implements Serializable{
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "equipment_nequipmentcode_seq")
	@SequenceGenerator(name = "equipment_nequipmentcode_seq", sequenceName = "equipment_nequipmentcode_seq", allocationSize = 1)
