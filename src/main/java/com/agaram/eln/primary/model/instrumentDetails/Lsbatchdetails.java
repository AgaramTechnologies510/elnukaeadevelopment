...
public class Lsbatchdetails {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsbatchdetails_seq")
	@SequenceGenerator(name = "lsbatchdetails_seq", sequenceName = "lsbatchdetails_seq", allocationSize = 1)
