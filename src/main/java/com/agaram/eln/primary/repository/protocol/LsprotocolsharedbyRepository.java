...
//	Long countBySharebyunifiedidAndSharestatusOrderBySharedbytoprotocolcodeDesc(String sharebyunifiedid, int i);
	...
	List<Lsprotocolsharedby> findBySharebyunifiedidAndSharestatusAndSitecodeOrderBySharedbytoprotocolcodeDesc(
			String sharebyunifiedid, int i, Integer sitecode);

	Long countBySharebyunifiedidAndSharestatusAndSitecodeOrderBySharedbytoprotocolcodeDesc(String sharebyunifiedid,
