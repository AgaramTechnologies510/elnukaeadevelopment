...
public class LSlogilabprotocolsteps {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lslogilabprotocolsteps_seq")
	@SequenceGenerator(name = "lslogilabprotocolsteps_seq", sequenceName = "lslogilabprotocolsteps_seq", allocationSize = 1)
