...
public class LSlogilablimsorderdetail {
	@Id
	@SequenceGenerator(name = "orderdetail_seq", sequenceName = "orderdetail_seq", initialValue = 1000000, allocationSize = 1)
	...
	private Integer sheetversionno;
	
	@ManyToOne
	private LSworkflow previousapprovedworkflow;
	
	private Integer workflowapprovedusercode;
	
	public LSworkflow getPreviousapprovedworkflow() {
		return previousapprovedworkflow;
	}

	public void setPreviousapprovedworkflow(LSworkflow previousapprovedworkflow) {
	...
	public Integer getSheetversionno() {
		return sheetversionno;
	}

	public void setSheetversionno(Integer sheetversionno) {
	...
	public interface ordersinterface {
		...
		Integer getOrdercancell();	
		 ...
		 @Value("#{target.lsprojectmaster != null ? target.lsprojectmaster.projectname : ''}")
...
//			this.lstworkflow = lstworkflow;
	...
	public interface OrderShareInterface {
		Long getBatchcode();
		...
		ElnmaterialInventory getElnmaterialinventory();

		List<LsOrderattachments> getLsOrderattachments();

		List<Lsorderworkflowhistory> getLsorderworkflowhistory();

		LSuserMaster getLsuserMaster();

		LSsamplemaster getLssamplemaster();
		...
		LSsamplefile getLssamplefile();

//		default boolean getCanuserprocess() {
//			return false;
//		}

		LSworkflow getPreviousapprovedworkflow();
...
//	    }
	    ...
	    boolean isCanuserprocess();
	    void setCanuserprocess(boolean canuserprocess);
	    default List<LSworkflow> getLstworkflow() {
