...
public class ReportTemplateVersion {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "reporttemplateversion_seq")
	@SequenceGenerator(name = "reporttemplateversion_seq", sequenceName = "reporttemplateversion_seq", allocationSize = 1)
