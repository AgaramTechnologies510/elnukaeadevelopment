...
public interface LsOrderSampleUpdateRepository extends JpaRepository<LsOrderSampleUpdate, Integer> {
...
//	    String getComment();
	...
	@Transactional
	@Modifying
	@Query(value = "select DISTINCT ls.batchcode ,(select batchid from lslogilablimsorderdetail  where batchcode=ls.batchcode ) as batchname,usercode from LsOrderSampleUpdate ls where repositorydatacode=?1", nativeQuery = true)
