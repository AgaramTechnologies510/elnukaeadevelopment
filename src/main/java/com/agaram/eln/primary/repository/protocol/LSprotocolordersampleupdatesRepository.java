...
//		    String getComment();
		...
		@Transactional
		@Modifying
		@Query(value = "select DISTINCT ls.protocolordercode ,(select protocolordername from lslogilabprotocoldetail  where protocolordercode=ls.protocolordercode ) as batchname,usercode from LSprotocolordersampleupdates ls where repositorydatacode=?1", nativeQuery = true)
