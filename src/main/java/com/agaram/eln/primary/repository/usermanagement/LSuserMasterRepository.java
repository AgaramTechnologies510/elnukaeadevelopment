...
public interface LSuserMasterRepository extends JpaRepository<LSuserMaster, Integer> {
	...
	public List<LSuserMaster> findByUsernameIgnoreCaseAndUsercodeInAndLoginfrom(String username,
			List<Integer> usercode, String string);
	...
	@Query(value = "SELECT DISTINCT usercode AS usercode, CAST(username AS VARCHAR) AS username FROM lsusermaster WHERE usercode IN (?1)", nativeQuery = true)
	...
	public Long countByUserretirestatusNotAndUserstatusNot(int i, String string);

	public List<LSuserMaster> findByUsernameIgnoreCase(String username);

	public List<LSuserMaster> findByUsernameIgnoreCaseAndUsercodeInAndUserretirestatusNotAndLoginfrom(String username,
			List<Integer> usercode1, int i, String string);

	public Integer countByusercodeNotAndUserretirestatusNotAndUserstatusNot(int i, int j, String string);

	public List<LSuserMaster> findByUsernameIgnoreCaseAndUserretirestatusNotAndLoginfrom(String username, int i,
			String string);

	public List<LSuserMaster> findByUsernameIgnoreCaseAndUsercodeInAndUserretirestatusNotAndLoginfromAndUserstatusNot(
			String username, List<Integer> usercode1, int i, String string, String string2);

	public List<LSuserMaster> findByUsernameIgnoreCaseAndUserretirestatusNotAndLoginfromAndUserstatusNot(
			String username, int i, String string, String string2);

	public List<LSuserMaster> findByUsernameIgnoreCaseAndUsercodeInAndLoginfromAndUserretirestatusNotAndUserstatusNot(
			String username, List<Integer> usercode, String string, int i, String string2);

	public List<LSuserMaster> findByUsernameIgnoreCaseAndUsercodeInAndUsercodeNotAndUserstatusNotAndUserretirestatusNot(
			String username, List<Integer> usercode, Integer usercode2, String string, int i);

	public List<LSuserMaster> findByUsernameIgnoreCaseAndUsercodeInAndUsercodeNotAndUserstatusNotAndUserretirestatusNotAndLoginfrom(
			String username, List<Integer> usercode, Integer usercode2, String string, int i, String string2);

	public LSuserMaster findByusercodeAndLssitemaster(Integer userID, LSSiteMaster objsite);

	public List<LSuserMaster> findByUserretirestatusAndUserstatusNot(int i, String string);

	public List<LSuserMaster> findByUsernameIgnoreCaseAndPassword(String getsUsername, String encryptedPassword);

	public List<LSuserMaster> findByUsercodeInAndUserstatusAndUserretirestatusAndUnifieduseridNotNullOrderByUsercodeDesc(
			List<Integer> lstuser, String string, int i);

	public LSuserMaster findByUsernameIgnoreCaseAndUsercodeInAndLoginfromAndIsadsuser(String username,
			List<Integer> usercode, String string, int i);
	
	public List<LSuserMaster> findByLssitemasterOrderByUsercodeDesc(LSSiteMaster objclass);

	public List<LSuserMaster> findByUsercodeInOrderByUsercodeDesc(List<Integer> usercode);

	public List<LSuserMaster> findByUsercodeInAndUserretirestatusNotOrderByUsercodeDesc(List<Integer> usercode, int i);

	public LSuserMaster findByUsercodeAndUnifieduseridIsNull(int i);

	public List<LSuserMaster> findByusernameIgnoreCaseIn(List<String> userNameList);
}