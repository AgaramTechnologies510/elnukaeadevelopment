...
public class EquipmentCategory {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "equipmentcategory_nequipmentcatcode_seq")
	@SequenceGenerator(name = "equipmentcategory_nequipmentcatcode_seq", sequenceName = "equipmentcategory_nequipmentcatcode_seq", allocationSize = 1)
