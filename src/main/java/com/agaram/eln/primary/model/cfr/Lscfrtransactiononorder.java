...
public class Lscfrtransactiononorder {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lscfrtransactiononorder_seq")
	@SequenceGenerator(name = "lscfrtransactiononorder_seq", sequenceName = "lscfrtransactiononorder_seq", allocationSize = 1)
