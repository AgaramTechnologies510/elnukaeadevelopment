...
public class LSprotocolorderversion {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsprotocolorderversion_seq")
	@SequenceGenerator(name = "lsprotocolorderversion_seq", sequenceName = "lsprotocolorderversion_seq", allocationSize = 1)
