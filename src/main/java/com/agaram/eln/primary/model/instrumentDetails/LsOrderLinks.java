...
public class LsOrderLinks {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsorderlinks_seq")
	@SequenceGenerator(name = "lsorderlinks_seq", sequenceName = "lsorderlinks_seq", allocationSize = 1)
