...
public class Manufacturer {
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "manufacturer_nmanufcode_seq")
	@SequenceGenerator(name = "manufacturer_nmanufcode_seq", sequenceName = "manufacturer_nmanufcode_seq", allocationSize = 1)
