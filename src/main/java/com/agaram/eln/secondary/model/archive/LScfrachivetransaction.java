...
public class LScfrachivetransaction {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "archivetransactions_seq")
	@SequenceGenerator(name = "archivetransactions_seq", sequenceName = "archivetransactions_seq", allocationSize = 1)
