...
public interface ElnmaterialInventoryRepository extends JpaRepository<ElnmaterialInventory, Integer>{
	...
	long countByMaterial(Elnmaterial matchedMaterial);

	List<ElnmaterialInventory> findByCreateddateBetweenOrderByNmaterialinventorycodeDesc(Date date, Date date2);

	List<ElnmaterialInventory> findBySequenceidAndNsitecode(String inventoryname, Integer nsiteInteger);

	List<ElnmaterialInventory> findBySequenceidInAndNsitecode(List<String> lstIds, Integer nsiteInteger);
