...
public interface MaterialCategoryRepository extends JpaRepository<MaterialCategory, Integer>{
	...
	public List<MaterialCategory> findByNsitecodeAndSmaterialcatnameIgnoreCaseIn(Integer siteCode,
			List<String> materialCatNames);
	public List<MaterialCategory> findByNsitecodeAndNdefaultstatusOrderByNmaterialcatcodeDesc(Integer nsitecode, int i);
	public List<MaterialCategory> findByNsitecodeNotAndNdefaultstatusOrderByNmaterialcatcodeDesc(int i, int j);
