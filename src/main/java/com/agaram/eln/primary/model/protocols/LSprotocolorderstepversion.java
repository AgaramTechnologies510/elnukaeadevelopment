...
public class LSprotocolorderstepversion {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsprotocolorderstepversion_seq")
	@SequenceGenerator(name = "lsprotocolorderstepversion_seq", sequenceName = "lsprotocolorderstepversion_seq", allocationSize = 1)
