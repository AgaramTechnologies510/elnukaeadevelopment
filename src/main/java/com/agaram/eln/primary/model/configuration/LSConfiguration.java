...
public class LSConfiguration {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "lsconfiguration_seq")
	@SequenceGenerator(name = "lsconfiguration_seq", sequenceName = "lsconfiguration_seq", allocationSize = 1)
